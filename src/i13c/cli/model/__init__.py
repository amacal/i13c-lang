...
from i13c.cli.model.llvm import LLVM
from i13c.cli.model.resolutions import RESOLUTIONS
from i13c.cli.model.rules import RULES
from i13c.cli.model.syntax import SYNTAX
...
def attach(target: click.Group) -> List[click.Command]:
    ...
    for key, extractor in RESOLUTIONS.items():
        commands.extend(attach_one2one_commands(model, key, extractor))
