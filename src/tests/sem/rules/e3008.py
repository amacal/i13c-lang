from i13c import ast, err, sem, src, sym
...
def can_detect_missing_called_symbol():
    ...
    # empty symbol table to simulate missing symbol
    symbols = sym.SymbolTable(entries={})

    diagnostics = sem.e3008.validate_called_symbol_exists(program, symbols)
