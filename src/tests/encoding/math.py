from i13c.semantic.typing.analyses.llvm import SUB
from tests.encoding import ImmediateInfo, RegisterInfo, encode_instruction, samples
...
@samples("""
    ...
    | --- | ---------- | -------------------- | --- | ---- | ---------- | -------------------- |
    """)
def can_encode_sub(dst: str, imm32: bytes, encoding: bytes):
    encode_instruction(
        SUB(
            operands=(
