...
PUSH_ADDR64 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; push qword [rel @prev5]      | 90 90 90 90 90 48 ff 35 f4 ff ff ff    |
    | .prev1: nop; push qword [rel @prev1]                          | 90 48 ff 35 f8 ff ff ff                |
    | push qword [rel @next1]; nop; .next1: nop                     | 48 ff 35 01 00 00 00 90 90             |
    | push qword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 48 ff 35 05 00 00 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------- | -------------------------------------- |
"""
...
PUSH_ADDR16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; push word [rel @prev5]      | 90 90 90 90 90 66 ff 35 f4 ff ff ff    |
    | .prev1: nop; push word [rel @prev1]                          | 90 66 ff 35 f8 ff ff ff                |
    | push word [rel @next1]; nop; .next1: nop                     | 66 ff 35 01 00 00 00 90 90             |
    | push word [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 66 ff 35 05 00 00 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------ | -------------------------------------- |
"""
