...
SBB_REG64_ADDR64 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb rax, qword [rel @prev5]      | 90 90 90 90 90 48 1b 05 f4 ff ff ff    |
    | .prev1: nop; sbb rax, qword [rel @prev1]                          | 90 48 1b 05 f8 ff ff ff                |
    | sbb rax, qword [rel @next1]; nop; .next1: nop                     | 48 1b 05 01 00 00 00 90 90             |
    | sbb rax, qword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 48 1b 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb rdx, qword [rel @prev5]      | 90 90 90 90 90 48 1b 15 f4 ff ff ff    |
    | .prev1: nop; sbb rbx, qword [rel @prev1]                          | 90 48 1b 1d f8 ff ff ff                |
    | sbb rsp, qword [rel @next1]; nop; .next1: nop                     | 48 1b 25 01 00 00 00 90 90             |
    | sbb rbp, qword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 48 1b 2d 05 00 00 00 90 90 90 90 90 90 |
    | sbb rsi, qword [rax]                                              | 48 1b 30                               |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
SBB_REG32_ADDR32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb eax, dword [rel @prev5]      | 90 90 90 90 90 1b 05 f5 ff ff ff    |
    | .prev1: nop; sbb eax, dword [rel @prev1]                          | 90 1b 05 f9 ff ff ff                |
    | sbb eax, dword [rel @next1]; nop; .next1: nop                     | 1b 05 01 00 00 00 90 90             |
    | sbb eax, dword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 1b 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb edx, dword [rel @prev5]      | 90 90 90 90 90 1b 15 f5 ff ff ff    |
    | .prev1: nop; sbb ebx, dword [rel @prev1]                          | 90 1b 1d f9 ff ff ff                |
    | sbb esp, dword [rel @next1]; nop; .next1: nop                     | 1b 25 01 00 00 00 90 90             |
    | sbb ebp, dword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 1b 2d 05 00 00 00 90 90 90 90 90 90 |
    | sbb esi, dword [rax]                                              | 1b 30                               |
    | ----------------------------------------------------------------- | ----------------------------------- |
"""
...
SBB_REG16_ADDR16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb ax, word [rel @prev5]      | 90 90 90 90 90 66 1b 05 f4 ff ff ff    |
    | .prev1: nop; sbb ax, word [rel @prev1]                          | 90 66 1b 05 f8 ff ff ff                |
    | sbb ax, word [rel @next1]; nop; .next1: nop                     | 66 1b 05 01 00 00 00 90 90             |
    | sbb ax, word [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 66 1b 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb dx, word [rel @prev5]      | 90 90 90 90 90 66 1b 15 f4 ff ff ff    |
    | .prev1: nop; sbb bx, word [rel @prev1]                          | 90 66 1b 1d f8 ff ff ff                |
    | sbb sp, word [rel @next1]; nop; .next1: nop                     | 66 1b 25 01 00 00 00 90 90             |
    | sbb bp, word [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 66 1b 2d 05 00 00 00 90 90 90 90 90 90 |
    | sbb si, word [rax]                                              | 66 1b 30                               |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
SBB_REG8_ADDR8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb al, byte [rel @prev5]       | 90 90 90 90 90 1a 05 f5 ff ff ff       |
    | .prev1: nop; sbb al, byte [rel @prev1]                           | 90 1a 05 f9 ff ff ff                   |
    | sbb al, byte [rel @next1]; nop; .next1: nop                      | 1a 05 01 00 00 00 90 90                |
    | sbb al, byte [rel @next5]; nop; nop; nop; nop; nop; .next5: nop  | 1a 05 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb dl, byte [rel @prev5]       | 90 90 90 90 90 1a 15 f5 ff ff ff       |
    | .prev1: nop; sbb bl, byte [rel @prev1]                           | 90 1a 1d f9 ff ff ff                   |
    | sbb spl, byte [rel @next1]; nop; .next1: nop                     | 40 1a 25 01 00 00 00 90 90             |
    | sbb bpl, byte [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 40 1a 2d 05 00 00 00 90 90 90 90 90 90 |
    | sbb sil, byte [rax]                                              | 40 1a 30                               |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
...
SBB_ADDR64_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb qword [rel @prev5], 0x01      | 90 90 90 90 90 48 83 1d f3 ff ff ff 01    |
    | .prev1: nop; sbb qword [rel @prev1], 0x01                          | 90 48 83 1d f7 ff ff ff 01                |
    | sbb qword [rel @next1], 0x01; nop; .next1: nop                     | 48 83 1d 01 00 00 00 01 90 90             |
    | sbb qword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 48 83 1d 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb qword [rel @prev5], 0xff      | 90 90 90 90 90 48 83 1d f3 ff ff ff ff    |
    | .prev1: nop; sbb qword [rel @prev1], 0x00                          | 90 48 83 1d f7 ff ff ff 00                |
    | sbb qword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 48 83 1d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | ----------------------------------------- |
"""
...
SBB_ADDR64_IMM32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb qword [rel @prev5], 0x00000001      | 90 90 90 90 90 48 81 1d f0 ff ff ff 01 00 00 00    |
    | .prev1: nop; sbb qword [rel @prev1], 0x00000001                          | 90 48 81 1d f4 ff ff ff 01 00 00 00                |
    | sbb qword [rel @next1], 0x00000001; nop; .next1: nop                     | 48 81 1d 01 00 00 00 01 00 00 00 90 90             |
    | sbb qword [rel @next5], 0x00000001; nop; nop; nop; nop; nop; .next5: nop | 48 81 1d 05 00 00 00 01 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb qword [rel @prev5], 0x00007fff      | 90 90 90 90 90 48 81 1d f0 ff ff ff ff 7f 00 00    |
    | .prev1: nop; sbb qword [rel @prev1], 0x00008000                          | 90 48 81 1d f4 ff ff ff 00 80 00 00                |
    | sbb qword [rel @next1], 0x0000ffff; nop; .next1: nop                     | 48 81 1d 01 00 00 00 ff ff 00 00 90 90             |
    | sbb qword [rel @next5], 0x00010000; nop; nop; nop; nop; nop; .next5: nop | 48 81 1d 05 00 00 00 00 00 01 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------------------ | -------------------------------------------------- |
"""
...
SBB_ADDR64_REG64 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb qword [rel @prev5], rcx      | 90 90 90 90 90 48 19 0d f4 ff ff ff    |
    | .prev1: nop; sbb qword [rel @prev1], rcx                          | 90 48 19 0d f8 ff ff ff                |
    | sbb qword [rel @next1], rcx; nop; .next1: nop                     | 48 19 0d 01 00 00 00 90 90             |
    | sbb qword [rel @next5], rcx; nop; nop; nop; nop; nop; .next5: nop | 48 19 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb qword [rel @prev5], rsp      | 90 90 90 90 90 48 19 25 f4 ff ff ff    |
    | .prev1: nop; sbb qword [rel @prev1], rbp                          | 90 48 19 2d f8 ff ff ff                |
    | sbb qword [rel @next1], rsi; nop; .next1: nop                     | 48 19 35 01 00 00 00 90 90             |
    | sbb qword [rel @next5], rdi; nop; nop; nop; nop; nop; .next5: nop | 48 19 3d 05 00 00 00 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
SBB_ADDR32_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb dword [rel @prev5], 0x01      | 90 90 90 90 90 83 1d f4 ff ff ff 01    |
    | .prev1: nop; sbb dword [rel @prev1], 0x01                          | 90 83 1d f8 ff ff ff 01                |
    | sbb dword [rel @next1], 0x01; nop; .next1: nop                     | 83 1d 01 00 00 00 01 90 90             |
    | sbb dword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 83 1d 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb dword [rel @prev5], 0xff      | 90 90 90 90 90 83 1d f4 ff ff ff ff    |
    | .prev1: nop; sbb dword [rel @prev1], 0x00                          | 90 83 1d f8 ff ff ff 00                |
    | sbb dword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 83 1d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | -------------------------------------- |
"""
...
SBB_ADDR32_IMM32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb dword [rel @prev5], 0x00000001      | 90 90 90 90 90 81 1d f1 ff ff ff 01 00 00 00    |
    | .prev1: nop; sbb dword [rel @prev1], 0x00000001                          | 90 81 1d f5 ff ff ff 01 00 00 00                |
    | sbb dword [rel @next1], 0x00000001; nop; .next1: nop                     | 81 1d 01 00 00 00 01 00 00 00 90 90             |
    | sbb dword [rel @next5], 0x00000001; nop; nop; nop; nop; nop; .next5: nop | 81 1d 05 00 00 00 01 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb dword [rel @prev5], 0x00007fff      | 90 90 90 90 90 81 1d f1 ff ff ff ff 7f 00 00    |
    | .prev1: nop; sbb dword [rel @prev1], 0x00008000                          | 90 81 1d f5 ff ff ff 00 80 00 00                |
    | sbb dword [rel @next1], 0x0000ffff; nop; .next1: nop                     | 81 1d 01 00 00 00 ff ff 00 00 90 90             |
    | sbb dword [rel @next5], 0x00010000; nop; nop; nop; nop; nop; .next5: nop | 81 1d 05 00 00 00 00 00 01 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------------------ | ----------------------------------------------- |
"""
...
SBB_ADDR32_REG32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb dword [rel @prev5], ecx      | 90 90 90 90 90 19 0d f5 ff ff ff    |
    | .prev1: nop; sbb dword [rel @prev1], ecx                          | 90 19 0d f9 ff ff ff                |
    | sbb dword [rel @next1], ecx; nop; .next1: nop                     | 19 0d 01 00 00 00 90 90             |
    | sbb dword [rel @next5], ecx; nop; nop; nop; nop; nop; .next5: nop | 19 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb dword [rel @prev5], esp      | 90 90 90 90 90 19 25 f5 ff ff ff    |
    | .prev1: nop; sbb dword [rel @prev1], ebp                          | 90 19 2d f9 ff ff ff                |
    | sbb dword [rel @next1], esi; nop; .next1: nop                     | 19 35 01 00 00 00 90 90             |
    | sbb dword [rel @next5], edi; nop; nop; nop; nop; nop; .next5: nop | 19 3d 05 00 00 00 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------- |
"""
...
SBB_ADDR16_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb word [rel @prev5], 0x01      | 90 90 90 90 90 66 83 1d f3 ff ff ff 01    |
    | .prev1: nop; sbb word [rel @prev1], 0x01                          | 90 66 83 1d f7 ff ff ff 01                |
    | sbb word [rel @next1], 0x01; nop; .next1: nop                     | 66 83 1d 01 00 00 00 01 90 90             |
    | sbb word [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 66 83 1d 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb word [rel @prev5], 0xff      | 90 90 90 90 90 66 83 1d f3 ff ff ff ff    |
    | .prev1: nop; sbb word [rel @prev1], 0x00                          | 90 66 83 1d f7 ff ff ff 00                |
    | sbb word [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 66 83 1d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------------- |
"""
...
SBB_ADDR16_IMM16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb word [rel @prev5], 0x0001      | 90 90 90 90 90 66 81 1d f2 ff ff ff 01 00    |
    | .prev1: nop; sbb word [rel @prev1], 0x0001                          | 90 66 81 1d f6 ff ff ff 01 00                |
    | sbb word [rel @next1], 0x0001; nop; .next1: nop                     | 66 81 1d 01 00 00 00 01 00 90 90             |
    | sbb word [rel @next5], 0x0001; nop; nop; nop; nop; nop; .next5: nop | 66 81 1d 05 00 00 00 01 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb word [rel @prev5], 0x0080      | 90 90 90 90 90 66 81 1d f2 ff ff ff 80 00    |
    | .prev1: nop; sbb word [rel @prev1], 0x00ff                          | 90 66 81 1d f6 ff ff ff ff 00                |
    | sbb word [rel @next1], 0x0100; nop; .next1: nop                     | 66 81 1d 01 00 00 00 00 01 90 90             |
    | sbb word [rel @next5], 0x7fff; nop; nop; nop; nop; nop; .next5: nop | 66 81 1d 05 00 00 00 ff 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------- | -------------------------------------------- |
"""
...
SBB_ADDR16_REG16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb word [rel @prev5], cx      | 90 90 90 90 90 66 19 0d f4 ff ff ff    |
    | .prev1: nop; sbb word [rel @prev1], cx                          | 90 66 19 0d f8 ff ff ff                |
    | sbb word [rel @next1], cx; nop; .next1: nop                     | 66 19 0d 01 00 00 00 90 90             |
    | sbb word [rel @next5], cx; nop; nop; nop; nop; nop; .next5: nop | 66 19 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb word [rel @prev5], sp      | 90 90 90 90 90 66 19 25 f4 ff ff ff    |
    | .prev1: nop; sbb word [rel @prev1], bp                          | 90 66 19 2d f8 ff ff ff                |
    | sbb word [rel @next1], si; nop; .next1: nop                     | 66 19 35 01 00 00 00 90 90             |
    | sbb word [rel @next5], di; nop; nop; nop; nop; nop; .next5: nop | 66 19 3d 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
SBB_ADDR8_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb byte [rel @prev5], 0x01      | 90 90 90 90 90 80 1d f4 ff ff ff 01    |
    | .prev1: nop; sbb byte [rel @prev1], 0x01                          | 90 80 1d f8 ff ff ff 01                |
    | sbb byte [rel @next1], 0x01; nop; .next1: nop                     | 80 1d 01 00 00 00 01 90 90             |
    | sbb byte [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 80 1d 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb byte [rel @prev5], 0xff      | 90 90 90 90 90 80 1d f4 ff ff ff ff    |
    | .prev1: nop; sbb byte [rel @prev1], 0x00                          | 90 80 1d f8 ff ff ff 00                |
    | sbb byte [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 80 1d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
SBB_ADDR8_REG8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb byte [rel @prev5], cl       | 90 90 90 90 90 18 0d f5 ff ff ff       |
    | .prev1: nop; sbb byte [rel @prev1], cl                           | 90 18 0d f9 ff ff ff                   |
    | sbb byte [rel @next1], cl; nop; .next1: nop                      | 18 0d 01 00 00 00 90 90                |
    | sbb byte [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop  | 18 0d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; sbb byte [rel @prev5], spl      | 90 90 90 90 90 40 18 25 f4 ff ff ff    |
    | .prev1: nop; sbb byte [rel @prev1], bpl                          | 90 40 18 2d f8 ff ff ff                |
    | sbb byte [rel @next1], sil; nop; .next1: nop                     | 40 18 35 01 00 00 00 90 90             |
    | sbb byte [rel @next5], dil; nop; nop; nop; nop; nop; .next5: nop | 40 18 3d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
