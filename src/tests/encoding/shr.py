...
SHR_ADDR64_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; shr qword [rel @prev5], 0x01      | 90 90 90 90 90 48 d1 2d f4 ff ff ff       |
    | .prev1: nop; shr qword [rel @prev1], 0x01                          | 90 48 d1 2d f8 ff ff ff                   |
    | shr qword [rel @next1], 0x01; nop; .next1: nop                     | 48 d1 2d 01 00 00 00 90 90                |
    | shr qword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 48 d1 2d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; shr qword [rel @prev5], 0xff      | 90 90 90 90 90 48 c1 2d f3 ff ff ff ff    |
    | .prev1: nop; shr qword [rel @prev1], 0x00                          | 90 48 c1 2d f7 ff ff ff 00                |
    | shr qword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 48 c1 2d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | ----------------------------------------- |
"""
...
SHR_ADDR64_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; shr qword [rel @prev5], cl      | 90 90 90 90 90 48 d3 2d f4 ff ff ff    |
    | .prev1: nop; shr qword [rel @prev1], cl                          | 90 48 d3 2d f8 ff ff ff                |
    | shr qword [rel @next1], cl; nop; .next1: nop                     | 48 d3 2d 01 00 00 00 90 90             |
    | shr qword [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | 48 d3 2d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
...
SHR_ADDR32_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; shr dword [rel @prev5], 0x01      | 90 90 90 90 90 d1 2d f5 ff ff ff       |
    | .prev1: nop; shr dword [rel @prev1], 0x01                          | 90 d1 2d f9 ff ff ff                   |
    | shr dword [rel @next1], 0x01; nop; .next1: nop                     | d1 2d 01 00 00 00 90 90                |
    | shr dword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | d1 2d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; shr dword [rel @prev5], 0xff      | 90 90 90 90 90 c1 2d f4 ff ff ff ff    |
    | .prev1: nop; shr dword [rel @prev1], 0x00                          | 90 c1 2d f8 ff ff ff 00                |
    | shr dword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | c1 2d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | -------------------------------------- |
"""
...
SHR_ADDR32_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; shr dword [rel @prev5], cl      | 90 90 90 90 90 d3 2d f5 ff ff ff    |
    | .prev1: nop; shr dword [rel @prev1], cl                          | 90 d3 2d f9 ff ff ff                |
    | shr dword [rel @next1], cl; nop; .next1: nop                     | d3 2d 01 00 00 00 90 90             |
    | shr dword [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | d3 2d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | ----------------------------------- |
"""
...
SHR_ADDR16_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; shr word [rel @prev5], 0x01      | 90 90 90 90 90 66 d1 2d f4 ff ff ff       |
    | .prev1: nop; shr word [rel @prev1], 0x01                          | 90 66 d1 2d f8 ff ff ff                   |
    | shr word [rel @next1], 0x01; nop; .next1: nop                     | 66 d1 2d 01 00 00 00 90 90                |
    | shr word [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 66 d1 2d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; shr word [rel @prev5], 0xff      | 90 90 90 90 90 66 c1 2d f3 ff ff ff ff    |
    | .prev1: nop; shr word [rel @prev1], 0x00                          | 90 66 c1 2d f7 ff ff ff 00                |
    | shr word [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 66 c1 2d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------------- |
"""
...
SHR_ADDR16_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; shr word [rel @prev5], cl      | 90 90 90 90 90 66 d3 2d f4 ff ff ff    |
    | .prev1: nop; shr word [rel @prev1], cl                          | 90 66 d3 2d f8 ff ff ff                |
    | shr word [rel @next1], cl; nop; .next1: nop                     | 66 d3 2d 01 00 00 00 90 90             |
    | shr word [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | 66 d3 2d 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
SHR_ADDR8_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; shr byte [rel @prev5], 0x01      | 90 90 90 90 90 d0 2d f5 ff ff ff       |
    | .prev1: nop; shr byte [rel @prev1], 0x01                          | 90 d0 2d f9 ff ff ff                   |
    | shr byte [rel @next1], 0x01; nop; .next1: nop                     | d0 2d 01 00 00 00 90 90                |
    | shr byte [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | d0 2d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; shr byte [rel @prev5], 0xff      | 90 90 90 90 90 c0 2d f4 ff ff ff ff    |
    | .prev1: nop; shr byte [rel @prev1], 0x00                          | 90 c0 2d f8 ff ff ff 00                |
    | shr byte [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | c0 2d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
SHR_ADDR8_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; shr byte [rel @prev5], cl      | 90 90 90 90 90 d2 2d f5 ff ff ff    |
    | .prev1: nop; shr byte [rel @prev1], cl                          | 90 d2 2d f9 ff ff ff                |
    | shr byte [rel @next1], cl; nop; .next1: nop                     | d2 2d 01 00 00 00 90 90             |
    | shr byte [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | d2 2d 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | ----------------------------------- |
"""
