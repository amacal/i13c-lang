...
SUB_REG64_ADDR64 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub rax, qword [rel @prev5]      | 90 90 90 90 90 48 2b 05 f4 ff ff ff    |
    | .prev1: nop; sub rax, qword [rel @prev1]                          | 90 48 2b 05 f8 ff ff ff                |
    | sub rax, qword [rel @next1]; nop; .next1: nop                     | 48 2b 05 01 00 00 00 90 90             |
    | sub rax, qword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 48 2b 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub rdx, qword [rel @prev5]      | 90 90 90 90 90 48 2b 15 f4 ff ff ff    |
    | .prev1: nop; sub rbx, qword [rel @prev1]                          | 90 48 2b 1d f8 ff ff ff                |
    | sub rsp, qword [rel @next1]; nop; .next1: nop                     | 48 2b 25 01 00 00 00 90 90             |
    | sub rbp, qword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 48 2b 2d 05 00 00 00 90 90 90 90 90 90 |
    | sub rsi, qword [rax]                                              | 48 2b 30                               |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
SUB_REG32_ADDR32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub eax, dword [rel @prev5]      | 90 90 90 90 90 2b 05 f5 ff ff ff    |
    | .prev1: nop; sub eax, dword [rel @prev1]                          | 90 2b 05 f9 ff ff ff                |
    | sub eax, dword [rel @next1]; nop; .next1: nop                     | 2b 05 01 00 00 00 90 90             |
    | sub eax, dword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 2b 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub edx, dword [rel @prev5]      | 90 90 90 90 90 2b 15 f5 ff ff ff    |
    | .prev1: nop; sub ebx, dword [rel @prev1]                          | 90 2b 1d f9 ff ff ff                |
    | sub esp, dword [rel @next1]; nop; .next1: nop                     | 2b 25 01 00 00 00 90 90             |
    | sub ebp, dword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 2b 2d 05 00 00 00 90 90 90 90 90 90 |
    | sub esi, dword [rax]                                              | 2b 30                               |
    | ----------------------------------------------------------------- | ----------------------------------- |
"""
...
SUB_REG16_ADDR16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub ax, word [rel @prev5]      | 90 90 90 90 90 66 2b 05 f4 ff ff ff    |
    | .prev1: nop; sub ax, word [rel @prev1]                          | 90 66 2b 05 f8 ff ff ff                |
    | sub ax, word [rel @next1]; nop; .next1: nop                     | 66 2b 05 01 00 00 00 90 90             |
    | sub ax, word [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 66 2b 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub dx, word [rel @prev5]      | 90 90 90 90 90 66 2b 15 f4 ff ff ff    |
    | .prev1: nop; sub bx, word [rel @prev1]                          | 90 66 2b 1d f8 ff ff ff                |
    | sub sp, word [rel @next1]; nop; .next1: nop                     | 66 2b 25 01 00 00 00 90 90             |
    | sub bp, word [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 66 2b 2d 05 00 00 00 90 90 90 90 90 90 |
    | sub si, word [rax]                                              | 66 2b 30                               |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
SUB_REG8_ADDR8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub al, byte [rel @prev5]       | 90 90 90 90 90 2a 05 f5 ff ff ff       |
    | .prev1: nop; sub al, byte [rel @prev1]                           | 90 2a 05 f9 ff ff ff                   |
    | sub al, byte [rel @next1]; nop; .next1: nop                      | 2a 05 01 00 00 00 90 90                |
    | sub al, byte [rel @next5]; nop; nop; nop; nop; nop; .next5: nop  | 2a 05 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub dl, byte [rel @prev5]       | 90 90 90 90 90 2a 15 f5 ff ff ff       |
    | .prev1: nop; sub bl, byte [rel @prev1]                           | 90 2a 1d f9 ff ff ff                   |
    | sub spl, byte [rel @next1]; nop; .next1: nop                     | 40 2a 25 01 00 00 00 90 90             |
    | sub bpl, byte [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 40 2a 2d 05 00 00 00 90 90 90 90 90 90 |
    | sub sil, byte [rax]                                              | 40 2a 30                               |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
...
SUB_ADDR64_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub qword [rel @prev5], 0x01      | 90 90 90 90 90 48 83 2d f3 ff ff ff 01    |
    | .prev1: nop; sub qword [rel @prev1], 0x01                          | 90 48 83 2d f7 ff ff ff 01                |
    | sub qword [rel @next1], 0x01; nop; .next1: nop                     | 48 83 2d 01 00 00 00 01 90 90             |
    | sub qword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 48 83 2d 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub qword [rel @prev5], 0xff      | 90 90 90 90 90 48 83 2d f3 ff ff ff ff    |
    | .prev1: nop; sub qword [rel @prev1], 0x00                          | 90 48 83 2d f7 ff ff ff 00                |
    | sub qword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 48 83 2d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | ----------------------------------------- |
"""
...
SUB_ADDR64_IMM32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub qword [rel @prev5], 0x00000001      | 90 90 90 90 90 48 81 2d f0 ff ff ff 01 00 00 00    |
    | .prev1: nop; sub qword [rel @prev1], 0x00000001                          | 90 48 81 2d f4 ff ff ff 01 00 00 00                |
    | sub qword [rel @next1], 0x00000001; nop; .next1: nop                     | 48 81 2d 01 00 00 00 01 00 00 00 90 90             |
    | sub qword [rel @next5], 0x00000001; nop; nop; nop; nop; nop; .next5: nop | 48 81 2d 05 00 00 00 01 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub qword [rel @prev5], 0x00007fff      | 90 90 90 90 90 48 81 2d f0 ff ff ff ff 7f 00 00    |
    | .prev1: nop; sub qword [rel @prev1], 0x00008000                          | 90 48 81 2d f4 ff ff ff 00 80 00 00                |
    | sub qword [rel @next1], 0x0000ffff; nop; .next1: nop                     | 48 81 2d 01 00 00 00 ff ff 00 00 90 90             |
    | sub qword [rel @next5], 0x00010000; nop; nop; nop; nop; nop; .next5: nop | 48 81 2d 05 00 00 00 00 00 01 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------------------ | -------------------------------------------------- |
"""
...
SUB_ADDR64_REG64 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub qword [rel @prev5], rcx      | 90 90 90 90 90 48 29 0d f4 ff ff ff    |
    | .prev1: nop; sub qword [rel @prev1], rcx                          | 90 48 29 0d f8 ff ff ff                |
    | sub qword [rel @next1], rcx; nop; .next1: nop                     | 48 29 0d 01 00 00 00 90 90             |
    | sub qword [rel @next5], rcx; nop; nop; nop; nop; nop; .next5: nop | 48 29 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub qword [rel @prev5], rsp      | 90 90 90 90 90 48 29 25 f4 ff ff ff    |
    | .prev1: nop; sub qword [rel @prev1], rbp                          | 90 48 29 2d f8 ff ff ff                |
    | sub qword [rel @next1], rsi; nop; .next1: nop                     | 48 29 35 01 00 00 00 90 90             |
    | sub qword [rel @next5], rdi; nop; nop; nop; nop; nop; .next5: nop | 48 29 3d 05 00 00 00 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
SUB_ADDR32_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub dword [rel @prev5], 0x01      | 90 90 90 90 90 83 2d f4 ff ff ff 01    |
    | .prev1: nop; sub dword [rel @prev1], 0x01                          | 90 83 2d f8 ff ff ff 01                |
    | sub dword [rel @next1], 0x01; nop; .next1: nop                     | 83 2d 01 00 00 00 01 90 90             |
    | sub dword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 83 2d 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub dword [rel @prev5], 0xff      | 90 90 90 90 90 83 2d f4 ff ff ff ff    |
    | .prev1: nop; sub dword [rel @prev1], 0x00                          | 90 83 2d f8 ff ff ff 00                |
    | sub dword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 83 2d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | -------------------------------------- |
"""
...
SUB_ADDR32_IMM32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub dword [rel @prev5], 0x00000001      | 90 90 90 90 90 81 2d f1 ff ff ff 01 00 00 00    |
    | .prev1: nop; sub dword [rel @prev1], 0x00000001                          | 90 81 2d f5 ff ff ff 01 00 00 00                |
    | sub dword [rel @next1], 0x00000001; nop; .next1: nop                     | 81 2d 01 00 00 00 01 00 00 00 90 90             |
    | sub dword [rel @next5], 0x00000001; nop; nop; nop; nop; nop; .next5: nop | 81 2d 05 00 00 00 01 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub dword [rel @prev5], 0x00007fff      | 90 90 90 90 90 81 2d f1 ff ff ff ff 7f 00 00    |
    | .prev1: nop; sub dword [rel @prev1], 0x00008000                          | 90 81 2d f5 ff ff ff 00 80 00 00                |
    | sub dword [rel @next1], 0x0000ffff; nop; .next1: nop                     | 81 2d 01 00 00 00 ff ff 00 00 90 90             |
    | sub dword [rel @next5], 0x00010000; nop; nop; nop; nop; nop; .next5: nop | 81 2d 05 00 00 00 00 00 01 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------------------ | ----------------------------------------------- |
"""
...
SUB_ADDR32_REG32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub dword [rel @prev5], ecx      | 90 90 90 90 90 29 0d f5 ff ff ff    |
    | .prev1: nop; sub dword [rel @prev1], ecx                          | 90 29 0d f9 ff ff ff                |
    | sub dword [rel @next1], ecx; nop; .next1: nop                     | 29 0d 01 00 00 00 90 90             |
    | sub dword [rel @next5], ecx; nop; nop; nop; nop; nop; .next5: nop | 29 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub dword [rel @prev5], esp      | 90 90 90 90 90 29 25 f5 ff ff ff    |
    | .prev1: nop; sub dword [rel @prev1], ebp                          | 90 29 2d f9 ff ff ff                |
    | sub dword [rel @next1], esi; nop; .next1: nop                     | 29 35 01 00 00 00 90 90             |
    | sub dword [rel @next5], edi; nop; nop; nop; nop; nop; .next5: nop | 29 3d 05 00 00 00 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------- |
"""
...
SUB_ADDR16_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub word [rel @prev5], 0x01      | 90 90 90 90 90 66 83 2d f3 ff ff ff 01    |
    | .prev1: nop; sub word [rel @prev1], 0x01                          | 90 66 83 2d f7 ff ff ff 01                |
    | sub word [rel @next1], 0x01; nop; .next1: nop                     | 66 83 2d 01 00 00 00 01 90 90             |
    | sub word [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 66 83 2d 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub word [rel @prev5], 0xff      | 90 90 90 90 90 66 83 2d f3 ff ff ff ff    |
    | .prev1: nop; sub word [rel @prev1], 0x00                          | 90 66 83 2d f7 ff ff ff 00                |
    | sub word [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 66 83 2d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------------- |
"""
...
SUB_ADDR16_IMM16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub word [rel @prev5], 0x0001      | 90 90 90 90 90 66 81 2d f2 ff ff ff 01 00    |
    | .prev1: nop; sub word [rel @prev1], 0x0001                          | 90 66 81 2d f6 ff ff ff 01 00                |
    | sub word [rel @next1], 0x0001; nop; .next1: nop                     | 66 81 2d 01 00 00 00 01 00 90 90             |
    | sub word [rel @next5], 0x0001; nop; nop; nop; nop; nop; .next5: nop | 66 81 2d 05 00 00 00 01 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub word [rel @prev5], 0x0080      | 90 90 90 90 90 66 81 2d f2 ff ff ff 80 00    |
    | .prev1: nop; sub word [rel @prev1], 0x00ff                          | 90 66 81 2d f6 ff ff ff ff 00                |
    | sub word [rel @next1], 0x0100; nop; .next1: nop                     | 66 81 2d 01 00 00 00 00 01 90 90             |
    | sub word [rel @next5], 0x7fff; nop; nop; nop; nop; nop; .next5: nop | 66 81 2d 05 00 00 00 ff 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------- | -------------------------------------------- |
"""
...
SUB_ADDR16_REG16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub word [rel @prev5], cx      | 90 90 90 90 90 66 29 0d f4 ff ff ff    |
    | .prev1: nop; sub word [rel @prev1], cx                          | 90 66 29 0d f8 ff ff ff                |
    | sub word [rel @next1], cx; nop; .next1: nop                     | 66 29 0d 01 00 00 00 90 90             |
    | sub word [rel @next5], cx; nop; nop; nop; nop; nop; .next5: nop | 66 29 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub word [rel @prev5], sp      | 90 90 90 90 90 66 29 25 f4 ff ff ff    |
    | .prev1: nop; sub word [rel @prev1], bp                          | 90 66 29 2d f8 ff ff ff                |
    | sub word [rel @next1], si; nop; .next1: nop                     | 66 29 35 01 00 00 00 90 90             |
    | sub word [rel @next5], di; nop; nop; nop; nop; nop; .next5: nop | 66 29 3d 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
SUB_ADDR8_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub byte [rel @prev5], 0x01      | 90 90 90 90 90 80 2d f4 ff ff ff 01    |
    | .prev1: nop; sub byte [rel @prev1], 0x01                          | 90 80 2d f8 ff ff ff 01                |
    | sub byte [rel @next1], 0x01; nop; .next1: nop                     | 80 2d 01 00 00 00 01 90 90             |
    | sub byte [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 80 2d 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub byte [rel @prev5], 0xff      | 90 90 90 90 90 80 2d f4 ff ff ff ff    |
    | .prev1: nop; sub byte [rel @prev1], 0x00                          | 90 80 2d f8 ff ff ff 00                |
    | sub byte [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 80 2d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
SUB_ADDR8_REG8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sub byte [rel @prev5], cl       | 90 90 90 90 90 28 0d f5 ff ff ff       |
    | .prev1: nop; sub byte [rel @prev1], cl                           | 90 28 0d f9 ff ff ff                   |
    | sub byte [rel @next1], cl; nop; .next1: nop                      | 28 0d 01 00 00 00 90 90                |
    | sub byte [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop  | 28 0d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; sub byte [rel @prev5], spl      | 90 90 90 90 90 40 28 25 f4 ff ff ff    |
    | .prev1: nop; sub byte [rel @prev1], bpl                          | 90 40 28 2d f8 ff ff ff                |
    | sub byte [rel @next1], sil; nop; .next1: nop                     | 40 28 35 01 00 00 00 90 90             |
    | sub byte [rel @next5], dil; nop; nop; nop; nop; nop; .next5: nop | 40 28 3d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
