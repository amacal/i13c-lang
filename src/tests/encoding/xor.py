...
XOR_REG64_ADDR64 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor rax, qword [rel @prev5]      | 90 90 90 90 90 48 33 05 f4 ff ff ff    |
    | .prev1: nop; xor rax, qword [rel @prev1]                          | 90 48 33 05 f8 ff ff ff                |
    | xor rax, qword [rel @next1]; nop; .next1: nop                     | 48 33 05 01 00 00 00 90 90             |
    | xor rax, qword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 48 33 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor rdx, qword [rel @prev5]      | 90 90 90 90 90 48 33 15 f4 ff ff ff    |
    | .prev1: nop; xor rbx, qword [rel @prev1]                          | 90 48 33 1d f8 ff ff ff                |
    | xor rsp, qword [rel @next1]; nop; .next1: nop                     | 48 33 25 01 00 00 00 90 90             |
    | xor rbp, qword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 48 33 2d 05 00 00 00 90 90 90 90 90 90 |
    | xor rsi, qword [rax]                                              | 48 33 30                               |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
XOR_REG32_ADDR32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor eax, dword [rel @prev5]      | 90 90 90 90 90 33 05 f5 ff ff ff    |
    | .prev1: nop; xor eax, dword [rel @prev1]                          | 90 33 05 f9 ff ff ff                |
    | xor eax, dword [rel @next1]; nop; .next1: nop                     | 33 05 01 00 00 00 90 90             |
    | xor eax, dword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 33 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor edx, dword [rel @prev5]      | 90 90 90 90 90 33 15 f5 ff ff ff    |
    | .prev1: nop; xor ebx, dword [rel @prev1]                          | 90 33 1d f9 ff ff ff                |
    | xor esp, dword [rel @next1]; nop; .next1: nop                     | 33 25 01 00 00 00 90 90             |
    | xor ebp, dword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 33 2d 05 00 00 00 90 90 90 90 90 90 |
    | xor esi, dword [rax]                                              | 33 30                               |
    | ----------------------------------------------------------------- | ----------------------------------- |
"""
...
XOR_REG16_ADDR16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor ax, word [rel @prev5]      | 90 90 90 90 90 66 33 05 f4 ff ff ff    |
    | .prev1: nop; xor ax, word [rel @prev1]                          | 90 66 33 05 f8 ff ff ff                |
    | xor ax, word [rel @next1]; nop; .next1: nop                     | 66 33 05 01 00 00 00 90 90             |
    | xor ax, word [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 66 33 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor dx, word [rel @prev5]      | 90 90 90 90 90 66 33 15 f4 ff ff ff    |
    | .prev1: nop; xor bx, word [rel @prev1]                          | 90 66 33 1d f8 ff ff ff                |
    | xor sp, word [rel @next1]; nop; .next1: nop                     | 66 33 25 01 00 00 00 90 90             |
    | xor bp, word [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 66 33 2d 05 00 00 00 90 90 90 90 90 90 |
    | xor si, word [rax]                                              | 66 33 30                               |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
XOR_REG8_ADDR8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor al, byte [rel @prev5]       | 90 90 90 90 90 32 05 f5 ff ff ff       |
    | .prev1: nop; xor al, byte [rel @prev1]                           | 90 32 05 f9 ff ff ff                   |
    | xor al, byte [rel @next1]; nop; .next1: nop                      | 32 05 01 00 00 00 90 90                |
    | xor al, byte [rel @next5]; nop; nop; nop; nop; nop; .next5: nop  | 32 05 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor dl, byte [rel @prev5]       | 90 90 90 90 90 32 15 f5 ff ff ff       |
    | .prev1: nop; xor bl, byte [rel @prev1]                           | 90 32 1d f9 ff ff ff                   |
    | xor spl, byte [rel @next1]; nop; .next1: nop                     | 40 32 25 01 00 00 00 90 90             |
    | xor bpl, byte [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 40 32 2d 05 00 00 00 90 90 90 90 90 90 |
    | xor sil, byte [rax]                                              | 40 32 30                               |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
...
XOR_ADDR64_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor qword [rel @prev5], 0x01      | 90 90 90 90 90 48 83 35 f3 ff ff ff 01    |
    | .prev1: nop; xor qword [rel @prev1], 0x01                          | 90 48 83 35 f7 ff ff ff 01                |
    | xor qword [rel @next1], 0x01; nop; .next1: nop                     | 48 83 35 01 00 00 00 01 90 90             |
    | xor qword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 48 83 35 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor qword [rel @prev5], 0xff      | 90 90 90 90 90 48 83 35 f3 ff ff ff ff    |
    | .prev1: nop; xor qword [rel @prev1], 0x00                          | 90 48 83 35 f7 ff ff ff 00                |
    | xor qword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 48 83 35 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | ----------------------------------------- |
"""
...
XOR_ADDR64_IMM32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor qword [rel @prev5], 0x00000001      | 90 90 90 90 90 48 81 35 f0 ff ff ff 01 00 00 00    |
    | .prev1: nop; xor qword [rel @prev1], 0x00000001                          | 90 48 81 35 f4 ff ff ff 01 00 00 00                |
    | xor qword [rel @next1], 0x00000001; nop; .next1: nop                     | 48 81 35 01 00 00 00 01 00 00 00 90 90             |
    | xor qword [rel @next5], 0x00000001; nop; nop; nop; nop; nop; .next5: nop | 48 81 35 05 00 00 00 01 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor qword [rel @prev5], 0x00007fff      | 90 90 90 90 90 48 81 35 f0 ff ff ff ff 7f 00 00    |
    | .prev1: nop; xor qword [rel @prev1], 0x00008000                          | 90 48 81 35 f4 ff ff ff 00 80 00 00                |
    | xor qword [rel @next1], 0x0000ffff; nop; .next1: nop                     | 48 81 35 01 00 00 00 ff ff 00 00 90 90             |
    | xor qword [rel @next5], 0x00010000; nop; nop; nop; nop; nop; .next5: nop | 48 81 35 05 00 00 00 00 00 01 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------------------ | -------------------------------------------------- |
"""
...
XOR_ADDR64_REG64 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor qword [rel @prev5], rcx      | 90 90 90 90 90 48 31 0d f4 ff ff ff    |
    | .prev1: nop; xor qword [rel @prev1], rcx                          | 90 48 31 0d f8 ff ff ff                |
    | xor qword [rel @next1], rcx; nop; .next1: nop                     | 48 31 0d 01 00 00 00 90 90             |
    | xor qword [rel @next5], rcx; nop; nop; nop; nop; nop; .next5: nop | 48 31 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor qword [rel @prev5], rsp      | 90 90 90 90 90 48 31 25 f4 ff ff ff    |
    | .prev1: nop; xor qword [rel @prev1], rbp                          | 90 48 31 2d f8 ff ff ff                |
    | xor qword [rel @next1], rsi; nop; .next1: nop                     | 48 31 35 01 00 00 00 90 90             |
    | xor qword [rel @next5], rdi; nop; nop; nop; nop; nop; .next5: nop | 48 31 3d 05 00 00 00 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
XOR_ADDR32_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor dword [rel @prev5], 0x01      | 90 90 90 90 90 83 35 f4 ff ff ff 01    |
    | .prev1: nop; xor dword [rel @prev1], 0x01                          | 90 83 35 f8 ff ff ff 01                |
    | xor dword [rel @next1], 0x01; nop; .next1: nop                     | 83 35 01 00 00 00 01 90 90             |
    | xor dword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 83 35 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor dword [rel @prev5], 0xff      | 90 90 90 90 90 83 35 f4 ff ff ff ff    |
    | .prev1: nop; xor dword [rel @prev1], 0x00                          | 90 83 35 f8 ff ff ff 00                |
    | xor dword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 83 35 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | -------------------------------------- |
"""
...
XOR_ADDR32_IMM32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor dword [rel @prev5], 0x00000001      | 90 90 90 90 90 81 35 f1 ff ff ff 01 00 00 00    |
    | .prev1: nop; xor dword [rel @prev1], 0x00000001                          | 90 81 35 f5 ff ff ff 01 00 00 00                |
    | xor dword [rel @next1], 0x00000001; nop; .next1: nop                     | 81 35 01 00 00 00 01 00 00 00 90 90             |
    | xor dword [rel @next5], 0x00000001; nop; nop; nop; nop; nop; .next5: nop | 81 35 05 00 00 00 01 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor dword [rel @prev5], 0x00007fff      | 90 90 90 90 90 81 35 f1 ff ff ff ff 7f 00 00    |
    | .prev1: nop; xor dword [rel @prev1], 0x00008000                          | 90 81 35 f5 ff ff ff 00 80 00 00                |
    | xor dword [rel @next1], 0x0000ffff; nop; .next1: nop                     | 81 35 01 00 00 00 ff ff 00 00 90 90             |
    | xor dword [rel @next5], 0x00010000; nop; nop; nop; nop; nop; .next5: nop | 81 35 05 00 00 00 00 00 01 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------------------ | ----------------------------------------------- |
"""
...
XOR_ADDR32_REG32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor dword [rel @prev5], ecx      | 90 90 90 90 90 31 0d f5 ff ff ff    |
    | .prev1: nop; xor dword [rel @prev1], ecx                          | 90 31 0d f9 ff ff ff                |
    | xor dword [rel @next1], ecx; nop; .next1: nop                     | 31 0d 01 00 00 00 90 90             |
    | xor dword [rel @next5], ecx; nop; nop; nop; nop; nop; .next5: nop | 31 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor dword [rel @prev5], esp      | 90 90 90 90 90 31 25 f5 ff ff ff    |
    | .prev1: nop; xor dword [rel @prev1], ebp                          | 90 31 2d f9 ff ff ff                |
    | xor dword [rel @next1], esi; nop; .next1: nop                     | 31 35 01 00 00 00 90 90             |
    | xor dword [rel @next5], edi; nop; nop; nop; nop; nop; .next5: nop | 31 3d 05 00 00 00 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------- |
"""
...
XOR_ADDR16_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor word [rel @prev5], 0x01      | 90 90 90 90 90 66 83 35 f3 ff ff ff 01    |
    | .prev1: nop; xor word [rel @prev1], 0x01                          | 90 66 83 35 f7 ff ff ff 01                |
    | xor word [rel @next1], 0x01; nop; .next1: nop                     | 66 83 35 01 00 00 00 01 90 90             |
    | xor word [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 66 83 35 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor word [rel @prev5], 0xff      | 90 90 90 90 90 66 83 35 f3 ff ff ff ff    |
    | .prev1: nop; xor word [rel @prev1], 0x00                          | 90 66 83 35 f7 ff ff ff 00                |
    | xor word [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 66 83 35 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------------- |
"""
...
XOR_ADDR16_IMM16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor word [rel @prev5], 0x0001      | 90 90 90 90 90 66 81 35 f2 ff ff ff 01 00    |
    | .prev1: nop; xor word [rel @prev1], 0x0001                          | 90 66 81 35 f6 ff ff ff 01 00                |
    | xor word [rel @next1], 0x0001; nop; .next1: nop                     | 66 81 35 01 00 00 00 01 00 90 90             |
    | xor word [rel @next5], 0x0001; nop; nop; nop; nop; nop; .next5: nop | 66 81 35 05 00 00 00 01 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor word [rel @prev5], 0x0080      | 90 90 90 90 90 66 81 35 f2 ff ff ff 80 00    |
    | .prev1: nop; xor word [rel @prev1], 0x00ff                          | 90 66 81 35 f6 ff ff ff ff 00                |
    | xor word [rel @next1], 0x0100; nop; .next1: nop                     | 66 81 35 01 00 00 00 00 01 90 90             |
    | xor word [rel @next5], 0x7fff; nop; nop; nop; nop; nop; .next5: nop | 66 81 35 05 00 00 00 ff 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------- | -------------------------------------------- |
"""
...
XOR_ADDR16_REG16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor word [rel @prev5], cx      | 90 90 90 90 90 66 31 0d f4 ff ff ff    |
    | .prev1: nop; xor word [rel @prev1], cx                          | 90 66 31 0d f8 ff ff ff                |
    | xor word [rel @next1], cx; nop; .next1: nop                     | 66 31 0d 01 00 00 00 90 90             |
    | xor word [rel @next5], cx; nop; nop; nop; nop; nop; .next5: nop | 66 31 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor word [rel @prev5], sp      | 90 90 90 90 90 66 31 25 f4 ff ff ff    |
    | .prev1: nop; xor word [rel @prev1], bp                          | 90 66 31 2d f8 ff ff ff                |
    | xor word [rel @next1], si; nop; .next1: nop                     | 66 31 35 01 00 00 00 90 90             |
    | xor word [rel @next5], di; nop; nop; nop; nop; nop; .next5: nop | 66 31 3d 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
XOR_ADDR8_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor byte [rel @prev5], 0x01      | 90 90 90 90 90 80 35 f4 ff ff ff 01    |
    | .prev1: nop; xor byte [rel @prev1], 0x01                          | 90 80 35 f8 ff ff ff 01                |
    | xor byte [rel @next1], 0x01; nop; .next1: nop                     | 80 35 01 00 00 00 01 90 90             |
    | xor byte [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 80 35 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor byte [rel @prev5], 0xff      | 90 90 90 90 90 80 35 f4 ff ff ff ff    |
    | .prev1: nop; xor byte [rel @prev1], 0x00                          | 90 80 35 f8 ff ff ff 00                |
    | xor byte [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 80 35 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
XOR_ADDR8_REG8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xor byte [rel @prev5], cl       | 90 90 90 90 90 30 0d f5 ff ff ff       |
    | .prev1: nop; xor byte [rel @prev1], cl                           | 90 30 0d f9 ff ff ff                   |
    | xor byte [rel @next1], cl; nop; .next1: nop                      | 30 0d 01 00 00 00 90 90                |
    | xor byte [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop  | 30 0d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; xor byte [rel @prev5], spl      | 90 90 90 90 90 40 30 25 f4 ff ff ff    |
    | .prev1: nop; xor byte [rel @prev1], bpl                          | 90 40 30 2d f8 ff ff ff                |
    | xor byte [rel @next1], sil; nop; .next1: nop                     | 40 30 35 01 00 00 00 90 90             |
    | xor byte [rel @next5], dil; nop; nop; nop; nop; nop; .next5: nop | 40 30 3d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
