...
ROR_ADDR64_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; ror qword [rel @prev5], 0x01      | 90 90 90 90 90 48 d1 0d f4 ff ff ff       |
    | .prev1: nop; ror qword [rel @prev1], 0x01                          | 90 48 d1 0d f8 ff ff ff                   |
    | ror qword [rel @next1], 0x01; nop; .next1: nop                     | 48 d1 0d 01 00 00 00 90 90                |
    | ror qword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 48 d1 0d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; ror qword [rel @prev5], 0xff      | 90 90 90 90 90 48 c1 0d f3 ff ff ff ff    |
    | .prev1: nop; ror qword [rel @prev1], 0x00                          | 90 48 c1 0d f7 ff ff ff 00                |
    | ror qword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 48 c1 0d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | ----------------------------------------- |
"""
...
ROR_ADDR64_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; ror qword [rel @prev5], cl      | 90 90 90 90 90 48 d3 0d f4 ff ff ff    |
    | .prev1: nop; ror qword [rel @prev1], cl                          | 90 48 d3 0d f8 ff ff ff                |
    | ror qword [rel @next1], cl; nop; .next1: nop                     | 48 d3 0d 01 00 00 00 90 90             |
    | ror qword [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | 48 d3 0d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
...
ROR_ADDR32_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; ror dword [rel @prev5], 0x01      | 90 90 90 90 90 d1 0d f5 ff ff ff       |
    | .prev1: nop; ror dword [rel @prev1], 0x01                          | 90 d1 0d f9 ff ff ff                   |
    | ror dword [rel @next1], 0x01; nop; .next1: nop                     | d1 0d 01 00 00 00 90 90                |
    | ror dword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | d1 0d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; ror dword [rel @prev5], 0xff      | 90 90 90 90 90 c1 0d f4 ff ff ff ff    |
    | .prev1: nop; ror dword [rel @prev1], 0x00                          | 90 c1 0d f8 ff ff ff 00                |
    | ror dword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | c1 0d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | -------------------------------------- |
"""
...
ROR_ADDR32_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; ror dword [rel @prev5], cl      | 90 90 90 90 90 d3 0d f5 ff ff ff    |
    | .prev1: nop; ror dword [rel @prev1], cl                          | 90 d3 0d f9 ff ff ff                |
    | ror dword [rel @next1], cl; nop; .next1: nop                     | d3 0d 01 00 00 00 90 90             |
    | ror dword [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | d3 0d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | ----------------------------------- |
"""
...
ROR_ADDR16_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; ror word [rel @prev5], 0x01      | 90 90 90 90 90 66 d1 0d f4 ff ff ff       |
    | .prev1: nop; ror word [rel @prev1], 0x01                          | 90 66 d1 0d f8 ff ff ff                   |
    | ror word [rel @next1], 0x01; nop; .next1: nop                     | 66 d1 0d 01 00 00 00 90 90                |
    | ror word [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 66 d1 0d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; ror word [rel @prev5], 0xff      | 90 90 90 90 90 66 c1 0d f3 ff ff ff ff    |
    | .prev1: nop; ror word [rel @prev1], 0x00                          | 90 66 c1 0d f7 ff ff ff 00                |
    | ror word [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 66 c1 0d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------------- |
"""
...
ROR_ADDR16_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; ror word [rel @prev5], cl      | 90 90 90 90 90 66 d3 0d f4 ff ff ff    |
    | .prev1: nop; ror word [rel @prev1], cl                          | 90 66 d3 0d f8 ff ff ff                |
    | ror word [rel @next1], cl; nop; .next1: nop                     | 66 d3 0d 01 00 00 00 90 90             |
    | ror word [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | 66 d3 0d 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
ROR_ADDR8_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; ror byte [rel @prev5], 0x01      | 90 90 90 90 90 d0 0d f5 ff ff ff       |
    | .prev1: nop; ror byte [rel @prev1], 0x01                          | 90 d0 0d f9 ff ff ff                   |
    | ror byte [rel @next1], 0x01; nop; .next1: nop                     | d0 0d 01 00 00 00 90 90                |
    | ror byte [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | d0 0d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; ror byte [rel @prev5], 0xff      | 90 90 90 90 90 c0 0d f4 ff ff ff ff    |
    | .prev1: nop; ror byte [rel @prev1], 0x00                          | 90 c0 0d f8 ff ff ff 00                |
    | ror byte [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | c0 0d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
ROR_ADDR8_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; ror byte [rel @prev5], cl      | 90 90 90 90 90 d2 0d f5 ff ff ff    |
    | .prev1: nop; ror byte [rel @prev1], cl                          | 90 d2 0d f9 ff ff ff                |
    | ror byte [rel @next1], cl; nop; .next1: nop                     | d2 0d 01 00 00 00 90 90             |
    | ror byte [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | d2 0d 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | ----------------------------------- |
"""
