...
CMP_REG64_ADDR64 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp rax, qword [rel @prev5]      | 90 90 90 90 90 48 3b 05 f4 ff ff ff    |
    | .prev1: nop; cmp rax, qword [rel @prev1]                          | 90 48 3b 05 f8 ff ff ff                |
    | cmp rax, qword [rel @next1]; nop; .next1: nop                     | 48 3b 05 01 00 00 00 90 90             |
    | cmp rax, qword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 48 3b 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp rdx, qword [rel @prev5]      | 90 90 90 90 90 48 3b 15 f4 ff ff ff    |
    | .prev1: nop; cmp rbx, qword [rel @prev1]                          | 90 48 3b 1d f8 ff ff ff                |
    | cmp rsp, qword [rel @next1]; nop; .next1: nop                     | 48 3b 25 01 00 00 00 90 90             |
    | cmp rbp, qword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 48 3b 2d 05 00 00 00 90 90 90 90 90 90 |
    | cmp rsi, qword [rax]                                              | 48 3b 30                               |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
CMP_REG32_ADDR32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp eax, dword [rel @prev5]      | 90 90 90 90 90 3b 05 f5 ff ff ff    |
    | .prev1: nop; cmp eax, dword [rel @prev1]                          | 90 3b 05 f9 ff ff ff                |
    | cmp eax, dword [rel @next1]; nop; .next1: nop                     | 3b 05 01 00 00 00 90 90             |
    | cmp eax, dword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 3b 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp edx, dword [rel @prev5]      | 90 90 90 90 90 3b 15 f5 ff ff ff    |
    | .prev1: nop; cmp ebx, dword [rel @prev1]                          | 90 3b 1d f9 ff ff ff                |
    | cmp esp, dword [rel @next1]; nop; .next1: nop                     | 3b 25 01 00 00 00 90 90             |
    | cmp ebp, dword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 3b 2d 05 00 00 00 90 90 90 90 90 90 |
    | cmp esi, dword [rax]                                              | 3b 30                               |
    | ----------------------------------------------------------------- | ----------------------------------- |
"""
...
CMP_REG16_ADDR16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp ax, word [rel @prev5]      | 90 90 90 90 90 66 3b 05 f4 ff ff ff    |
    | .prev1: nop; cmp ax, word [rel @prev1]                          | 90 66 3b 05 f8 ff ff ff                |
    | cmp ax, word [rel @next1]; nop; .next1: nop                     | 66 3b 05 01 00 00 00 90 90             |
    | cmp ax, word [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 66 3b 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp dx, word [rel @prev5]      | 90 90 90 90 90 66 3b 15 f4 ff ff ff    |
    | .prev1: nop; cmp bx, word [rel @prev1]                          | 90 66 3b 1d f8 ff ff ff                |
    | cmp sp, word [rel @next1]; nop; .next1: nop                     | 66 3b 25 01 00 00 00 90 90             |
    | cmp bp, word [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 66 3b 2d 05 00 00 00 90 90 90 90 90 90 |
    | cmp si, word [rax]                                              | 66 3b 30                               |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
CMP_REG8_ADDR8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp al, byte [rel @prev5]       | 90 90 90 90 90 3a 05 f5 ff ff ff       |
    | .prev1: nop; cmp al, byte [rel @prev1]                           | 90 3a 05 f9 ff ff ff                   |
    | cmp al, byte [rel @next1]; nop; .next1: nop                      | 3a 05 01 00 00 00 90 90                |
    | cmp al, byte [rel @next5]; nop; nop; nop; nop; nop; .next5: nop  | 3a 05 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp dl, byte [rel @prev5]       | 90 90 90 90 90 3a 15 f5 ff ff ff       |
    | .prev1: nop; cmp bl, byte [rel @prev1]                           | 90 3a 1d f9 ff ff ff                   |
    | cmp spl, byte [rel @next1]; nop; .next1: nop                     | 40 3a 25 01 00 00 00 90 90             |
    | cmp bpl, byte [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 40 3a 2d 05 00 00 00 90 90 90 90 90 90 |
    | cmp sil, byte [rax]                                              | 40 3a 30                               |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
...
CMP_ADDR64_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp qword [rel @prev5], 0x01      | 90 90 90 90 90 48 83 3d f3 ff ff ff 01    |
    | .prev1: nop; cmp qword [rel @prev1], 0x01                          | 90 48 83 3d f7 ff ff ff 01                |
    | cmp qword [rel @next1], 0x01; nop; .next1: nop                     | 48 83 3d 01 00 00 00 01 90 90             |
    | cmp qword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 48 83 3d 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp qword [rel @prev5], 0xff      | 90 90 90 90 90 48 83 3d f3 ff ff ff ff    |
    | .prev1: nop; cmp qword [rel @prev1], 0x00                          | 90 48 83 3d f7 ff ff ff 00                |
    | cmp qword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 48 83 3d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | ----------------------------------------- |
"""
...
CMP_ADDR64_IMM32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp qword [rel @prev5], 0x00000001      | 90 90 90 90 90 48 81 3d f0 ff ff ff 01 00 00 00    |
    | .prev1: nop; cmp qword [rel @prev1], 0x00000001                          | 90 48 81 3d f4 ff ff ff 01 00 00 00                |
    | cmp qword [rel @next1], 0x00000001; nop; .next1: nop                     | 48 81 3d 01 00 00 00 01 00 00 00 90 90             |
    | cmp qword [rel @next5], 0x00000001; nop; nop; nop; nop; nop; .next5: nop | 48 81 3d 05 00 00 00 01 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp qword [rel @prev5], 0x00007fff      | 90 90 90 90 90 48 81 3d f0 ff ff ff ff 7f 00 00    |
    | .prev1: nop; cmp qword [rel @prev1], 0x00008000                          | 90 48 81 3d f4 ff ff ff 00 80 00 00                |
    | cmp qword [rel @next1], 0x0000ffff; nop; .next1: nop                     | 48 81 3d 01 00 00 00 ff ff 00 00 90 90             |
    | cmp qword [rel @next5], 0x00010000; nop; nop; nop; nop; nop; .next5: nop | 48 81 3d 05 00 00 00 00 00 01 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------------------ | -------------------------------------------------- |
"""
...
CMP_ADDR64_REG64 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp qword [rel @prev5], rcx      | 90 90 90 90 90 48 39 0d f4 ff ff ff    |
    | .prev1: nop; cmp qword [rel @prev1], rcx                          | 90 48 39 0d f8 ff ff ff                |
    | cmp qword [rel @next1], rcx; nop; .next1: nop                     | 48 39 0d 01 00 00 00 90 90             |
    | cmp qword [rel @next5], rcx; nop; nop; nop; nop; nop; .next5: nop | 48 39 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp qword [rel @prev5], rsp      | 90 90 90 90 90 48 39 25 f4 ff ff ff    |
    | .prev1: nop; cmp qword [rel @prev1], rbp                          | 90 48 39 2d f8 ff ff ff                |
    | cmp qword [rel @next1], rsi; nop; .next1: nop                     | 48 39 35 01 00 00 00 90 90             |
    | cmp qword [rel @next5], rdi; nop; nop; nop; nop; nop; .next5: nop | 48 39 3d 05 00 00 00 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
CMP_ADDR32_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp dword [rel @prev5], 0x01      | 90 90 90 90 90 83 3d f4 ff ff ff 01    |
    | .prev1: nop; cmp dword [rel @prev1], 0x01                          | 90 83 3d f8 ff ff ff 01                |
    | cmp dword [rel @next1], 0x01; nop; .next1: nop                     | 83 3d 01 00 00 00 01 90 90             |
    | cmp dword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 83 3d 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp dword [rel @prev5], 0xff      | 90 90 90 90 90 83 3d f4 ff ff ff ff    |
    | .prev1: nop; cmp dword [rel @prev1], 0x00                          | 90 83 3d f8 ff ff ff 00                |
    | cmp dword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 83 3d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | -------------------------------------- |
"""
...
CMP_ADDR32_IMM32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp dword [rel @prev5], 0x00000001      | 90 90 90 90 90 81 3d f1 ff ff ff 01 00 00 00    |
    | .prev1: nop; cmp dword [rel @prev1], 0x00000001                          | 90 81 3d f5 ff ff ff 01 00 00 00                |
    | cmp dword [rel @next1], 0x00000001; nop; .next1: nop                     | 81 3d 01 00 00 00 01 00 00 00 90 90             |
    | cmp dword [rel @next5], 0x00000001; nop; nop; nop; nop; nop; .next5: nop | 81 3d 05 00 00 00 01 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp dword [rel @prev5], 0x00007fff      | 90 90 90 90 90 81 3d f1 ff ff ff ff 7f 00 00    |
    | .prev1: nop; cmp dword [rel @prev1], 0x00008000                          | 90 81 3d f5 ff ff ff 00 80 00 00                |
    | cmp dword [rel @next1], 0x0000ffff; nop; .next1: nop                     | 81 3d 01 00 00 00 ff ff 00 00 90 90             |
    | cmp dword [rel @next5], 0x00010000; nop; nop; nop; nop; nop; .next5: nop | 81 3d 05 00 00 00 00 00 01 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------------------ | ----------------------------------------------- |
"""
...
CMP_ADDR32_REG32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp dword [rel @prev5], ecx      | 90 90 90 90 90 39 0d f5 ff ff ff    |
    | .prev1: nop; cmp dword [rel @prev1], ecx                          | 90 39 0d f9 ff ff ff                |
    | cmp dword [rel @next1], ecx; nop; .next1: nop                     | 39 0d 01 00 00 00 90 90             |
    | cmp dword [rel @next5], ecx; nop; nop; nop; nop; nop; .next5: nop | 39 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp dword [rel @prev5], esp      | 90 90 90 90 90 39 25 f5 ff ff ff    |
    | .prev1: nop; cmp dword [rel @prev1], ebp                          | 90 39 2d f9 ff ff ff                |
    | cmp dword [rel @next1], esi; nop; .next1: nop                     | 39 35 01 00 00 00 90 90             |
    | cmp dword [rel @next5], edi; nop; nop; nop; nop; nop; .next5: nop | 39 3d 05 00 00 00 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------- |
"""
...
CMP_ADDR16_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp word [rel @prev5], 0x01      | 90 90 90 90 90 66 83 3d f3 ff ff ff 01    |
    | .prev1: nop; cmp word [rel @prev1], 0x01                          | 90 66 83 3d f7 ff ff ff 01                |
    | cmp word [rel @next1], 0x01; nop; .next1: nop                     | 66 83 3d 01 00 00 00 01 90 90             |
    | cmp word [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 66 83 3d 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp word [rel @prev5], 0xff      | 90 90 90 90 90 66 83 3d f3 ff ff ff ff    |
    | .prev1: nop; cmp word [rel @prev1], 0x00                          | 90 66 83 3d f7 ff ff ff 00                |
    | cmp word [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 66 83 3d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------------- |
"""
...
CMP_ADDR16_IMM16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp word [rel @prev5], 0x0001      | 90 90 90 90 90 66 81 3d f2 ff ff ff 01 00    |
    | .prev1: nop; cmp word [rel @prev1], 0x0001                          | 90 66 81 3d f6 ff ff ff 01 00                |
    | cmp word [rel @next1], 0x0001; nop; .next1: nop                     | 66 81 3d 01 00 00 00 01 00 90 90             |
    | cmp word [rel @next5], 0x0001; nop; nop; nop; nop; nop; .next5: nop | 66 81 3d 05 00 00 00 01 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp word [rel @prev5], 0x0080      | 90 90 90 90 90 66 81 3d f2 ff ff ff 80 00    |
    | .prev1: nop; cmp word [rel @prev1], 0x00ff                          | 90 66 81 3d f6 ff ff ff ff 00                |
    | cmp word [rel @next1], 0x0100; nop; .next1: nop                     | 66 81 3d 01 00 00 00 00 01 90 90             |
    | cmp word [rel @next5], 0x7fff; nop; nop; nop; nop; nop; .next5: nop | 66 81 3d 05 00 00 00 ff 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------- | -------------------------------------------- |
"""
...
CMP_ADDR16_REG16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp word [rel @prev5], cx      | 90 90 90 90 90 66 39 0d f4 ff ff ff    |
    | .prev1: nop; cmp word [rel @prev1], cx                          | 90 66 39 0d f8 ff ff ff                |
    | cmp word [rel @next1], cx; nop; .next1: nop                     | 66 39 0d 01 00 00 00 90 90             |
    | cmp word [rel @next5], cx; nop; nop; nop; nop; nop; .next5: nop | 66 39 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp word [rel @prev5], sp      | 90 90 90 90 90 66 39 25 f4 ff ff ff    |
    | .prev1: nop; cmp word [rel @prev1], bp                          | 90 66 39 2d f8 ff ff ff                |
    | cmp word [rel @next1], si; nop; .next1: nop                     | 66 39 35 01 00 00 00 90 90             |
    | cmp word [rel @next5], di; nop; nop; nop; nop; nop; .next5: nop | 66 39 3d 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
CMP_ADDR8_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp byte [rel @prev5], 0x01      | 90 90 90 90 90 80 3d f4 ff ff ff 01    |
    | .prev1: nop; cmp byte [rel @prev1], 0x01                          | 90 80 3d f8 ff ff ff 01                |
    | cmp byte [rel @next1], 0x01; nop; .next1: nop                     | 80 3d 01 00 00 00 01 90 90             |
    | cmp byte [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 80 3d 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp byte [rel @prev5], 0xff      | 90 90 90 90 90 80 3d f4 ff ff ff ff    |
    | .prev1: nop; cmp byte [rel @prev1], 0x00                          | 90 80 3d f8 ff ff ff 00                |
    | cmp byte [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 80 3d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
CMP_ADDR8_REG8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp byte [rel @prev5], cl       | 90 90 90 90 90 38 0d f5 ff ff ff       |
    | .prev1: nop; cmp byte [rel @prev1], cl                           | 90 38 0d f9 ff ff ff                   |
    | cmp byte [rel @next1], cl; nop; .next1: nop                      | 38 0d 01 00 00 00 90 90                |
    | cmp byte [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop  | 38 0d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; cmp byte [rel @prev5], spl      | 90 90 90 90 90 40 38 25 f4 ff ff ff    |
    | .prev1: nop; cmp byte [rel @prev1], bpl                          | 90 40 38 2d f8 ff ff ff                |
    | cmp byte [rel @next1], sil; nop; .next1: nop                     | 40 38 35 01 00 00 00 90 90             |
    | cmp byte [rel @next5], dil; nop; nop; nop; nop; nop; .next5: nop | 40 38 3d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
