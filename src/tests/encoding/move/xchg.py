...
XCHG_REG64_ADDR64 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg rax, qword [rel @prev5]      | 90 90 90 90 90 48 87 05 f4 ff ff ff    |
    | .prev1: nop; xchg rax, qword [rel @prev1]                          | 90 48 87 05 f8 ff ff ff                |
    | xchg rax, qword [rel @next1]; nop; .next1: nop                     | 48 87 05 01 00 00 00 90 90             |
    | xchg rax, qword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 48 87 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg rdx, qword [rel @prev5]      | 90 90 90 90 90 48 87 15 f4 ff ff ff    |
    | .prev1: nop; xchg rbx, qword [rel @prev1]                          | 90 48 87 1d f8 ff ff ff                |
    | xchg rsp, qword [rel @next1]; nop; .next1: nop                     | 48 87 25 01 00 00 00 90 90             |
    | xchg rbp, qword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 48 87 2d 05 00 00 00 90 90 90 90 90 90 |
    | xchg rsi, qword [rax]                                              | 48 87 30                               |
    | ------------------------------------------------------------------ | -------------------------------------- |
"""
...
XCHG_REG32_ADDR32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg eax, dword [rel @prev5]      | 90 90 90 90 90 87 05 f5 ff ff ff    |
    | .prev1: nop; xchg eax, dword [rel @prev1]                          | 90 87 05 f9 ff ff ff                |
    | xchg eax, dword [rel @next1]; nop; .next1: nop                     | 87 05 01 00 00 00 90 90             |
    | xchg eax, dword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 87 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg edx, dword [rel @prev5]      | 90 90 90 90 90 87 15 f5 ff ff ff    |
    | .prev1: nop; xchg ebx, dword [rel @prev1]                          | 90 87 1d f9 ff ff ff                |
    | xchg esp, dword [rel @next1]; nop; .next1: nop                     | 87 25 01 00 00 00 90 90             |
    | xchg ebp, dword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 87 2d 05 00 00 00 90 90 90 90 90 90 |
    | xchg esi, dword [rax]                                              | 87 30                               |
    | ------------------------------------------------------------------ | ----------------------------------- |
"""
...
XCHG_REG16_ADDR16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg ax, word [rel @prev5]      | 90 90 90 90 90 66 87 05 f4 ff ff ff    |
    | .prev1: nop; xchg ax, word [rel @prev1]                          | 90 66 87 05 f8 ff ff ff                |
    | xchg ax, word [rel @next1]; nop; .next1: nop                     | 66 87 05 01 00 00 00 90 90             |
    | xchg ax, word [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 66 87 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg dx, word [rel @prev5]      | 90 90 90 90 90 66 87 15 f4 ff ff ff    |
    | .prev1: nop; xchg bx, word [rel @prev1]                          | 90 66 87 1d f8 ff ff ff                |
    | xchg sp, word [rel @next1]; nop; .next1: nop                     | 66 87 25 01 00 00 00 90 90             |
    | xchg bp, word [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 66 87 2d 05 00 00 00 90 90 90 90 90 90 |
    | xchg si, word [rax]                                              | 66 87 30                               |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
...
XCHG_REG8_ADDR8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg al, byte [rel @prev5]       | 90 90 90 90 90 86 05 f5 ff ff ff       |
    | .prev1: nop; xchg al, byte [rel @prev1]                           | 90 86 05 f9 ff ff ff                   |
    | xchg al, byte [rel @next1]; nop; .next1: nop                      | 86 05 01 00 00 00 90 90                |
    | xchg al, byte [rel @next5]; nop; nop; nop; nop; nop; .next5: nop  | 86 05 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg dl, byte [rel @prev5]       | 90 90 90 90 90 86 15 f5 ff ff ff       |
    | .prev1: nop; xchg bl, byte [rel @prev1]                           | 90 86 1d f9 ff ff ff                   |
    | xchg spl, byte [rel @next1]; nop; .next1: nop                     | 40 86 25 01 00 00 00 90 90             |
    | xchg bpl, byte [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 40 86 2d 05 00 00 00 90 90 90 90 90 90 |
    | xchg sil, byte [rax]                                              | 40 86 30                               |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
XCHG_ADDR64_REG64 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg qword [rel @prev5], rcx      | 90 90 90 90 90 48 87 0d f4 ff ff ff    |
    | .prev1: nop; xchg qword [rel @prev1], rcx                          | 90 48 87 0d f8 ff ff ff                |
    | xchg qword [rel @next1], rcx; nop; .next1: nop                     | 48 87 0d 01 00 00 00 90 90             |
    | xchg qword [rel @next5], rcx; nop; nop; nop; nop; nop; .next5: nop | 48 87 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg qword [rel @prev5], rsp      | 90 90 90 90 90 48 87 25 f4 ff ff ff    |
    | .prev1: nop; xchg qword [rel @prev1], rbp                          | 90 48 87 2d f8 ff ff ff                |
    | xchg qword [rel @next1], rsi; nop; .next1: nop                     | 48 87 35 01 00 00 00 90 90             |
    | xchg qword [rel @next5], rdi; nop; nop; nop; nop; nop; .next5: nop | 48 87 3d 05 00 00 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | -------------------------------------- |
"""
...
XCHG_ADDR32_REG32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg dword [rel @prev5], ecx      | 90 90 90 90 90 87 0d f5 ff ff ff    |
    | .prev1: nop; xchg dword [rel @prev1], ecx                          | 90 87 0d f9 ff ff ff                |
    | xchg dword [rel @next1], ecx; nop; .next1: nop                     | 87 0d 01 00 00 00 90 90             |
    | xchg dword [rel @next5], ecx; nop; nop; nop; nop; nop; .next5: nop | 87 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg dword [rel @prev5], esp      | 90 90 90 90 90 87 25 f5 ff ff ff    |
    | .prev1: nop; xchg dword [rel @prev1], ebp                          | 90 87 2d f9 ff ff ff                |
    | xchg dword [rel @next1], esi; nop; .next1: nop                     | 87 35 01 00 00 00 90 90             |
    | xchg dword [rel @next5], edi; nop; nop; nop; nop; nop; .next5: nop | 87 3d 05 00 00 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | ----------------------------------- |
"""
...
XCHG_ADDR16_REG16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg word [rel @prev5], cx      | 90 90 90 90 90 66 87 0d f4 ff ff ff    |
    | .prev1: nop; xchg word [rel @prev1], cx                          | 90 66 87 0d f8 ff ff ff                |
    | xchg word [rel @next1], cx; nop; .next1: nop                     | 66 87 0d 01 00 00 00 90 90             |
    | xchg word [rel @next5], cx; nop; nop; nop; nop; nop; .next5: nop | 66 87 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg word [rel @prev5], sp      | 90 90 90 90 90 66 87 25 f4 ff ff ff    |
    | .prev1: nop; xchg word [rel @prev1], bp                          | 90 66 87 2d f8 ff ff ff                |
    | xchg word [rel @next1], si; nop; .next1: nop                     | 66 87 35 01 00 00 00 90 90             |
    | xchg word [rel @next5], di; nop; nop; nop; nop; nop; .next5: nop | 66 87 3d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
...
XCHG_ADDR8_REG8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg byte [rel @prev5], cl       | 90 90 90 90 90 86 0d f5 ff ff ff       |
    | .prev1: nop; xchg byte [rel @prev1], cl                           | 90 86 0d f9 ff ff ff                   |
    | xchg byte [rel @next1], cl; nop; .next1: nop                      | 86 0d 01 00 00 00 90 90                |
    | xchg byte [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop  | 86 0d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; xchg byte [rel @prev5], spl      | 90 90 90 90 90 40 86 25 f4 ff ff ff    |
    | .prev1: nop; xchg byte [rel @prev1], bpl                          | 90 40 86 2d f8 ff ff ff                |
    | xchg byte [rel @next1], sil; nop; .next1: nop                     | 40 86 35 01 00 00 00 90 90             |
    | xchg byte [rel @next5], dil; nop; nop; nop; nop; nop; .next5: nop | 40 86 3d 05 00 00 00 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
