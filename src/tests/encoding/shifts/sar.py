...
SAR_ADDR64_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sar qword [rel @prev5], 0x01      | 90 90 90 90 90 48 d1 3d f4 ff ff ff       |
    | .prev1: nop; sar qword [rel @prev1], 0x01                          | 90 48 d1 3d f8 ff ff ff                   |
    | sar qword [rel @next1], 0x01; nop; .next1: nop                     | 48 d1 3d 01 00 00 00 90 90                |
    | sar qword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 48 d1 3d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; sar qword [rel @prev5], 0xff      | 90 90 90 90 90 48 c1 3d f3 ff ff ff ff    |
    | .prev1: nop; sar qword [rel @prev1], 0x00                          | 90 48 c1 3d f7 ff ff ff 00                |
    | sar qword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 48 c1 3d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | ----------------------------------------- |
"""
...
SAR_ADDR64_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sar qword [rel @prev5], cl      | 90 90 90 90 90 48 d3 3d f4 ff ff ff    |
    | .prev1: nop; sar qword [rel @prev1], cl                          | 90 48 d3 3d f8 ff ff ff                |
    | sar qword [rel @next1], cl; nop; .next1: nop                     | 48 d3 3d 01 00 00 00 90 90             |
    | sar qword [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | 48 d3 3d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
...
SAR_ADDR32_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sar dword [rel @prev5], 0x01      | 90 90 90 90 90 d1 3d f5 ff ff ff       |
    | .prev1: nop; sar dword [rel @prev1], 0x01                          | 90 d1 3d f9 ff ff ff                   |
    | sar dword [rel @next1], 0x01; nop; .next1: nop                     | d1 3d 01 00 00 00 90 90                |
    | sar dword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | d1 3d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; sar dword [rel @prev5], 0xff      | 90 90 90 90 90 c1 3d f4 ff ff ff ff    |
    | .prev1: nop; sar dword [rel @prev1], 0x00                          | 90 c1 3d f8 ff ff ff 00                |
    | sar dword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | c1 3d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | -------------------------------------- |
"""
...
SAR_ADDR32_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sar dword [rel @prev5], cl      | 90 90 90 90 90 d3 3d f5 ff ff ff    |
    | .prev1: nop; sar dword [rel @prev1], cl                          | 90 d3 3d f9 ff ff ff                |
    | sar dword [rel @next1], cl; nop; .next1: nop                     | d3 3d 01 00 00 00 90 90             |
    | sar dword [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | d3 3d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | ----------------------------------- |
"""
...
SAR_ADDR16_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sar word [rel @prev5], 0x01      | 90 90 90 90 90 66 d1 3d f4 ff ff ff       |
    | .prev1: nop; sar word [rel @prev1], 0x01                          | 90 66 d1 3d f8 ff ff ff                   |
    | sar word [rel @next1], 0x01; nop; .next1: nop                     | 66 d1 3d 01 00 00 00 90 90                |
    | sar word [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 66 d1 3d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; sar word [rel @prev5], 0xff      | 90 90 90 90 90 66 c1 3d f3 ff ff ff ff    |
    | .prev1: nop; sar word [rel @prev1], 0x00                          | 90 66 c1 3d f7 ff ff ff 00                |
    | sar word [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 66 c1 3d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------------- |
"""
...
SAR_ADDR16_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sar word [rel @prev5], cl      | 90 90 90 90 90 66 d3 3d f4 ff ff ff    |
    | .prev1: nop; sar word [rel @prev1], cl                          | 90 66 d3 3d f8 ff ff ff                |
    | sar word [rel @next1], cl; nop; .next1: nop                     | 66 d3 3d 01 00 00 00 90 90             |
    | sar word [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | 66 d3 3d 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
SAR_ADDR8_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sar byte [rel @prev5], 0x01      | 90 90 90 90 90 d0 3d f5 ff ff ff       |
    | .prev1: nop; sar byte [rel @prev1], 0x01                          | 90 d0 3d f9 ff ff ff                   |
    | sar byte [rel @next1], 0x01; nop; .next1: nop                     | d0 3d 01 00 00 00 90 90                |
    | sar byte [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | d0 3d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; sar byte [rel @prev5], 0xff      | 90 90 90 90 90 c0 3d f4 ff ff ff ff    |
    | .prev1: nop; sar byte [rel @prev1], 0x00                          | 90 c0 3d f8 ff ff ff 00                |
    | sar byte [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | c0 3d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
SAR_ADDR8_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sar byte [rel @prev5], cl      | 90 90 90 90 90 d2 3d f5 ff ff ff    |
    | .prev1: nop; sar byte [rel @prev1], cl                          | 90 d2 3d f9 ff ff ff                |
    | sar byte [rel @next1], cl; nop; .next1: nop                     | d2 3d 01 00 00 00 90 90             |
    | sar byte [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | d2 3d 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | ----------------------------------- |
"""
