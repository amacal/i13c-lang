...
RCR_ADDR64_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; rcr qword [rel @prev5], 0x01      | 90 90 90 90 90 48 d1 1d f4 ff ff ff       |
    | .prev1: nop; rcr qword [rel @prev1], 0x01                          | 90 48 d1 1d f8 ff ff ff                   |
    | rcr qword [rel @next1], 0x01; nop; .next1: nop                     | 48 d1 1d 01 00 00 00 90 90                |
    | rcr qword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 48 d1 1d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; rcr qword [rel @prev5], 0xff      | 90 90 90 90 90 48 c1 1d f3 ff ff ff ff    |
    | .prev1: nop; rcr qword [rel @prev1], 0x00                          | 90 48 c1 1d f7 ff ff ff 00                |
    | rcr qword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 48 c1 1d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | ----------------------------------------- |
"""
...
RCR_ADDR64_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; rcr qword [rel @prev5], cl      | 90 90 90 90 90 48 d3 1d f4 ff ff ff    |
    | .prev1: nop; rcr qword [rel @prev1], cl                          | 90 48 d3 1d f8 ff ff ff                |
    | rcr qword [rel @next1], cl; nop; .next1: nop                     | 48 d3 1d 01 00 00 00 90 90             |
    | rcr qword [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | 48 d3 1d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
...
RCR_ADDR32_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; rcr dword [rel @prev5], 0x01      | 90 90 90 90 90 d1 1d f5 ff ff ff       |
    | .prev1: nop; rcr dword [rel @prev1], 0x01                          | 90 d1 1d f9 ff ff ff                   |
    | rcr dword [rel @next1], 0x01; nop; .next1: nop                     | d1 1d 01 00 00 00 90 90                |
    | rcr dword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | d1 1d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; rcr dword [rel @prev5], 0xff      | 90 90 90 90 90 c1 1d f4 ff ff ff ff    |
    | .prev1: nop; rcr dword [rel @prev1], 0x00                          | 90 c1 1d f8 ff ff ff 00                |
    | rcr dword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | c1 1d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | -------------------------------------- |
"""
...
RCR_ADDR32_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; rcr dword [rel @prev5], cl      | 90 90 90 90 90 d3 1d f5 ff ff ff    |
    | .prev1: nop; rcr dword [rel @prev1], cl                          | 90 d3 1d f9 ff ff ff                |
    | rcr dword [rel @next1], cl; nop; .next1: nop                     | d3 1d 01 00 00 00 90 90             |
    | rcr dword [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | d3 1d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | ----------------------------------- |
"""
...
RCR_ADDR16_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; rcr word [rel @prev5], 0x01      | 90 90 90 90 90 66 d1 1d f4 ff ff ff       |
    | .prev1: nop; rcr word [rel @prev1], 0x01                          | 90 66 d1 1d f8 ff ff ff                   |
    | rcr word [rel @next1], 0x01; nop; .next1: nop                     | 66 d1 1d 01 00 00 00 90 90                |
    | rcr word [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 66 d1 1d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; rcr word [rel @prev5], 0xff      | 90 90 90 90 90 66 c1 1d f3 ff ff ff ff    |
    | .prev1: nop; rcr word [rel @prev1], 0x00                          | 90 66 c1 1d f7 ff ff ff 00                |
    | rcr word [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 66 c1 1d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------------- |
"""
...
RCR_ADDR16_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; rcr word [rel @prev5], cl      | 90 90 90 90 90 66 d3 1d f4 ff ff ff    |
    | .prev1: nop; rcr word [rel @prev1], cl                          | 90 66 d3 1d f8 ff ff ff                |
    | rcr word [rel @next1], cl; nop; .next1: nop                     | 66 d3 1d 01 00 00 00 90 90             |
    | rcr word [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | 66 d3 1d 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
RCR_ADDR8_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; rcr byte [rel @prev5], 0x01      | 90 90 90 90 90 d0 1d f5 ff ff ff       |
    | .prev1: nop; rcr byte [rel @prev1], 0x01                          | 90 d0 1d f9 ff ff ff                   |
    | rcr byte [rel @next1], 0x01; nop; .next1: nop                     | d0 1d 01 00 00 00 90 90                |
    | rcr byte [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | d0 1d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; rcr byte [rel @prev5], 0xff      | 90 90 90 90 90 c0 1d f4 ff ff ff ff    |
    | .prev1: nop; rcr byte [rel @prev1], 0x00                          | 90 c0 1d f8 ff ff ff 00                |
    | rcr byte [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | c0 1d 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
RCR_ADDR8_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; rcr byte [rel @prev5], cl      | 90 90 90 90 90 d2 1d f5 ff ff ff    |
    | .prev1: nop; rcr byte [rel @prev1], cl                          | 90 d2 1d f9 ff ff ff                |
    | rcr byte [rel @next1], cl; nop; .next1: nop                     | d2 1d 01 00 00 00 90 90             |
    | rcr byte [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | d2 1d 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | ----------------------------------- |
"""
