...
SAL_ADDR64_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sal qword [rel @prev5], 0x01      | 90 90 90 90 90 48 d1 25 f4 ff ff ff       |
    | .prev1: nop; sal qword [rel @prev1], 0x01                          | 90 48 d1 25 f8 ff ff ff                   |
    | sal qword [rel @next1], 0x01; nop; .next1: nop                     | 48 d1 25 01 00 00 00 90 90                |
    | sal qword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 48 d1 25 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; sal qword [rel @prev5], 0xff      | 90 90 90 90 90 48 c1 25 f3 ff ff ff ff    |
    | .prev1: nop; sal qword [rel @prev1], 0x00                          | 90 48 c1 25 f7 ff ff ff 00                |
    | sal qword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 48 c1 25 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | ----------------------------------------- |
"""
...
SAL_ADDR64_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sal qword [rel @prev5], cl      | 90 90 90 90 90 48 d3 25 f4 ff ff ff    |
    | .prev1: nop; sal qword [rel @prev1], cl                          | 90 48 d3 25 f8 ff ff ff                |
    | sal qword [rel @next1], cl; nop; .next1: nop                     | 48 d3 25 01 00 00 00 90 90             |
    | sal qword [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | 48 d3 25 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
...
SAL_ADDR32_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sal dword [rel @prev5], 0x01      | 90 90 90 90 90 d1 25 f5 ff ff ff       |
    | .prev1: nop; sal dword [rel @prev1], 0x01                          | 90 d1 25 f9 ff ff ff                   |
    | sal dword [rel @next1], 0x01; nop; .next1: nop                     | d1 25 01 00 00 00 90 90                |
    | sal dword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | d1 25 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; sal dword [rel @prev5], 0xff      | 90 90 90 90 90 c1 25 f4 ff ff ff ff    |
    | .prev1: nop; sal dword [rel @prev1], 0x00                          | 90 c1 25 f8 ff ff ff 00                |
    | sal dword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | c1 25 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | -------------------------------------- |
"""
...
SAL_ADDR32_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sal dword [rel @prev5], cl      | 90 90 90 90 90 d3 25 f5 ff ff ff    |
    | .prev1: nop; sal dword [rel @prev1], cl                          | 90 d3 25 f9 ff ff ff                |
    | sal dword [rel @next1], cl; nop; .next1: nop                     | d3 25 01 00 00 00 90 90             |
    | sal dword [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | d3 25 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | ----------------------------------- |
"""
...
SAL_ADDR16_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sal word [rel @prev5], 0x01      | 90 90 90 90 90 66 d1 25 f4 ff ff ff       |
    | .prev1: nop; sal word [rel @prev1], 0x01                          | 90 66 d1 25 f8 ff ff ff                   |
    | sal word [rel @next1], 0x01; nop; .next1: nop                     | 66 d1 25 01 00 00 00 90 90                |
    | sal word [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 66 d1 25 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; sal word [rel @prev5], 0xff      | 90 90 90 90 90 66 c1 25 f3 ff ff ff ff    |
    | .prev1: nop; sal word [rel @prev1], 0x00                          | 90 66 c1 25 f7 ff ff ff 00                |
    | sal word [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 66 c1 25 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------------- |
"""
...
SAL_ADDR16_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sal word [rel @prev5], cl      | 90 90 90 90 90 66 d3 25 f4 ff ff ff    |
    | .prev1: nop; sal word [rel @prev1], cl                          | 90 66 d3 25 f8 ff ff ff                |
    | sal word [rel @next1], cl; nop; .next1: nop                     | 66 d3 25 01 00 00 00 90 90             |
    | sal word [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | 66 d3 25 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
SAL_ADDR8_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sal byte [rel @prev5], 0x01      | 90 90 90 90 90 d0 25 f5 ff ff ff       |
    | .prev1: nop; sal byte [rel @prev1], 0x01                          | 90 d0 25 f9 ff ff ff                   |
    | sal byte [rel @next1], 0x01; nop; .next1: nop                     | d0 25 01 00 00 00 90 90                |
    | sal byte [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | d0 25 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; sal byte [rel @prev5], 0xff      | 90 90 90 90 90 c0 25 f4 ff ff ff ff    |
    | .prev1: nop; sal byte [rel @prev1], 0x00                          | 90 c0 25 f8 ff ff ff 00                |
    | sal byte [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | c0 25 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
SAL_ADDR8_CL = """
    ...
    | .prev5: nop; nop; nop; nop; nop; sal byte [rel @prev5], cl      | 90 90 90 90 90 d2 25 f5 ff ff ff    |
    | .prev1: nop; sal byte [rel @prev1], cl                          | 90 d2 25 f9 ff ff ff                |
    | sal byte [rel @next1], cl; nop; .next1: nop                     | d2 25 01 00 00 00 90 90             |
    | sal byte [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop | d2 25 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | ----------------------------------- |
"""
