...
ADD_REG64_ADDR64 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add rax, qword [rel @prev5]      | 90 90 90 90 90 48 03 05 f4 ff ff ff    |
    | .prev1: nop; add rax, qword [rel @prev1]                          | 90 48 03 05 f8 ff ff ff                |
    | add rax, qword [rel @next1]; nop; .next1: nop                     | 48 03 05 01 00 00 00 90 90             |
    | add rax, qword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 48 03 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; add rdx, qword [rel @prev5]      | 90 90 90 90 90 48 03 15 f4 ff ff ff    |
    | .prev1: nop; add rbx, qword [rel @prev1]                          | 90 48 03 1d f8 ff ff ff                |
    | add rsp, qword [rel @next1]; nop; .next1: nop                     | 48 03 25 01 00 00 00 90 90             |
    | add rbp, qword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 48 03 2d 05 00 00 00 90 90 90 90 90 90 |
    | add rsi, qword [rax]                                              | 48 03 30                               |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
ADD_REG32_ADDR32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add eax, dword [rel @prev5]      | 90 90 90 90 90 03 05 f5 ff ff ff    |
    | .prev1: nop; add eax, dword [rel @prev1]                          | 90 03 05 f9 ff ff ff                |
    | add eax, dword [rel @next1]; nop; .next1: nop                     | 03 05 01 00 00 00 90 90             |
    | add eax, dword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 03 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; add edx, dword [rel @prev5]      | 90 90 90 90 90 03 15 f5 ff ff ff    |
    | .prev1: nop; add ebx, dword [rel @prev1]                          | 90 03 1d f9 ff ff ff                |
    | add esp, dword [rel @next1]; nop; .next1: nop                     | 03 25 01 00 00 00 90 90             |
    | add ebp, dword [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 03 2d 05 00 00 00 90 90 90 90 90 90 |
    | add esi, dword [rax]                                              | 03 30                               |
    | ----------------------------------------------------------------- | ----------------------------------- |
"""
...
ADD_REG16_ADDR16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add ax, word [rel @prev5]      | 90 90 90 90 90 66 03 05 f4 ff ff ff    |
    | .prev1: nop; add ax, word [rel @prev1]                          | 90 66 03 05 f8 ff ff ff                |
    | add ax, word [rel @next1]; nop; .next1: nop                     | 66 03 05 01 00 00 00 90 90             |
    | add ax, word [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 66 03 05 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; add dx, word [rel @prev5]      | 90 90 90 90 90 66 03 15 f4 ff ff ff    |
    | .prev1: nop; add bx, word [rel @prev1]                          | 90 66 03 1d f8 ff ff ff                |
    | add sp, word [rel @next1]; nop; .next1: nop                     | 66 03 25 01 00 00 00 90 90             |
    | add bp, word [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 66 03 2d 05 00 00 00 90 90 90 90 90 90 |
    | add si, word [rax]                                              | 66 03 30                               |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
ADD_REG8_ADDR8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add al, byte [rel @prev5]       | 90 90 90 90 90 02 05 f5 ff ff ff       |
    | .prev1: nop; add al, byte [rel @prev1]                           | 90 02 05 f9 ff ff ff                   |
    | add al, byte [rel @next1]; nop; .next1: nop                      | 02 05 01 00 00 00 90 90                |
    | add al, byte [rel @next5]; nop; nop; nop; nop; nop; .next5: nop  | 02 05 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; add dl, byte [rel @prev5]       | 90 90 90 90 90 02 15 f5 ff ff ff       |
    | .prev1: nop; add bl, byte [rel @prev1]                           | 90 02 1d f9 ff ff ff                   |
    | add spl, byte [rel @next1]; nop; .next1: nop                     | 40 02 25 01 00 00 00 90 90             |
    | add bpl, byte [rel @next5]; nop; nop; nop; nop; nop; .next5: nop | 40 02 2d 05 00 00 00 90 90 90 90 90 90 |
    | add sil, byte [rax]                                              | 40 02 30                               |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
...
ADD_ADDR64_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add qword [rel @prev5], 0x01      | 90 90 90 90 90 48 83 05 f3 ff ff ff 01    |
    | .prev1: nop; add qword [rel @prev1], 0x01                          | 90 48 83 05 f7 ff ff ff 01                |
    | add qword [rel @next1], 0x01; nop; .next1: nop                     | 48 83 05 01 00 00 00 01 90 90             |
    | add qword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 48 83 05 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; add qword [rel @prev5], 0xff      | 90 90 90 90 90 48 83 05 f3 ff ff ff ff    |
    | .prev1: nop; add qword [rel @prev1], 0x00                          | 90 48 83 05 f7 ff ff ff 00                |
    | add qword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 48 83 05 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | ----------------------------------------- |
"""
...
ADD_ADDR64_IMM32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add qword [rel @prev5], 0x00000001      | 90 90 90 90 90 48 81 05 f0 ff ff ff 01 00 00 00    |
    | .prev1: nop; add qword [rel @prev1], 0x00000001                          | 90 48 81 05 f4 ff ff ff 01 00 00 00                |
    | add qword [rel @next1], 0x00000001; nop; .next1: nop                     | 48 81 05 01 00 00 00 01 00 00 00 90 90             |
    | add qword [rel @next5], 0x00000001; nop; nop; nop; nop; nop; .next5: nop | 48 81 05 05 00 00 00 01 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; add qword [rel @prev5], 0x00007fff      | 90 90 90 90 90 48 81 05 f0 ff ff ff ff 7f 00 00    |
    | .prev1: nop; add qword [rel @prev1], 0x00008000                          | 90 48 81 05 f4 ff ff ff 00 80 00 00                |
    | add qword [rel @next1], 0x0000ffff; nop; .next1: nop                     | 48 81 05 01 00 00 00 ff ff 00 00 90 90             |
    | add qword [rel @next5], 0x00010000; nop; nop; nop; nop; nop; .next5: nop | 48 81 05 05 00 00 00 00 00 01 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------------------ | -------------------------------------------------- |
"""
...
ADD_ADDR64_REG64 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add qword [rel @prev5], rcx      | 90 90 90 90 90 48 01 0d f4 ff ff ff    |
    | .prev1: nop; add qword [rel @prev1], rcx                          | 90 48 01 0d f8 ff ff ff                |
    | add qword [rel @next1], rcx; nop; .next1: nop                     | 48 01 0d 01 00 00 00 90 90             |
    | add qword [rel @next5], rcx; nop; nop; nop; nop; nop; .next5: nop | 48 01 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; add qword [rel @prev5], rsp      | 90 90 90 90 90 48 01 25 f4 ff ff ff    |
    | .prev1: nop; add qword [rel @prev1], rbp                          | 90 48 01 2d f8 ff ff ff                |
    | add qword [rel @next1], rsi; nop; .next1: nop                     | 48 01 35 01 00 00 00 90 90             |
    | add qword [rel @next5], rdi; nop; nop; nop; nop; nop; .next5: nop | 48 01 3d 05 00 00 00 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
ADD_ADDR32_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add dword [rel @prev5], 0x01      | 90 90 90 90 90 83 05 f4 ff ff ff 01    |
    | .prev1: nop; add dword [rel @prev1], 0x01                          | 90 83 05 f8 ff ff ff 01                |
    | add dword [rel @next1], 0x01; nop; .next1: nop                     | 83 05 01 00 00 00 01 90 90             |
    | add dword [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 83 05 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; add dword [rel @prev5], 0xff      | 90 90 90 90 90 83 05 f4 ff ff ff ff    |
    | .prev1: nop; add dword [rel @prev1], 0x00                          | 90 83 05 f8 ff ff ff 00                |
    | add dword [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 83 05 05 00 00 00 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------ | -------------------------------------- |
"""
...
ADD_ADDR32_IMM32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add dword [rel @prev5], 0x00000001      | 90 90 90 90 90 81 05 f1 ff ff ff 01 00 00 00    |
    | .prev1: nop; add dword [rel @prev1], 0x00000001                          | 90 81 05 f5 ff ff ff 01 00 00 00                |
    | add dword [rel @next1], 0x00000001; nop; .next1: nop                     | 81 05 01 00 00 00 01 00 00 00 90 90             |
    | add dword [rel @next5], 0x00000001; nop; nop; nop; nop; nop; .next5: nop | 81 05 05 00 00 00 01 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; add dword [rel @prev5], 0x00007fff      | 90 90 90 90 90 81 05 f1 ff ff ff ff 7f 00 00    |
    | .prev1: nop; add dword [rel @prev1], 0x00008000                          | 90 81 05 f5 ff ff ff 00 80 00 00                |
    | add dword [rel @next1], 0x0000ffff; nop; .next1: nop                     | 81 05 01 00 00 00 ff ff 00 00 90 90             |
    | add dword [rel @next5], 0x00010000; nop; nop; nop; nop; nop; .next5: nop | 81 05 05 00 00 00 00 00 01 00 90 90 90 90 90 90 |
    | ------------------------------------------------------------------------ | ----------------------------------------------- |
"""
...
ADD_ADDR32_REG32 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add dword [rel @prev5], ecx      | 90 90 90 90 90 01 0d f5 ff ff ff    |
    | .prev1: nop; add dword [rel @prev1], ecx                          | 90 01 0d f9 ff ff ff                |
    | add dword [rel @next1], ecx; nop; .next1: nop                     | 01 0d 01 00 00 00 90 90             |
    | add dword [rel @next5], ecx; nop; nop; nop; nop; nop; .next5: nop | 01 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; add dword [rel @prev5], esp      | 90 90 90 90 90 01 25 f5 ff ff ff    |
    | .prev1: nop; add dword [rel @prev1], ebp                          | 90 01 2d f9 ff ff ff                |
    | add dword [rel @next1], esi; nop; .next1: nop                     | 01 35 01 00 00 00 90 90             |
    | add dword [rel @next5], edi; nop; nop; nop; nop; nop; .next5: nop | 01 3d 05 00 00 00 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------- |
"""
...
ADD_ADDR16_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add word [rel @prev5], 0x01      | 90 90 90 90 90 66 83 05 f3 ff ff ff 01    |
    | .prev1: nop; add word [rel @prev1], 0x01                          | 90 66 83 05 f7 ff ff ff 01                |
    | add word [rel @next1], 0x01; nop; .next1: nop                     | 66 83 05 01 00 00 00 01 90 90             |
    | add word [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 66 83 05 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; add word [rel @prev5], 0xff      | 90 90 90 90 90 66 83 05 f3 ff ff ff ff    |
    | .prev1: nop; add word [rel @prev1], 0x00                          | 90 66 83 05 f7 ff ff ff 00                |
    | add word [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 66 83 05 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | ----------------------------------------- |
"""
...
ADD_ADDR16_IMM16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add word [rel @prev5], 0x0001      | 90 90 90 90 90 66 81 05 f2 ff ff ff 01 00    |
    | .prev1: nop; add word [rel @prev1], 0x0001                          | 90 66 81 05 f6 ff ff ff 01 00                |
    | add word [rel @next1], 0x0001; nop; .next1: nop                     | 66 81 05 01 00 00 00 01 00 90 90             |
    | add word [rel @next5], 0x0001; nop; nop; nop; nop; nop; .next5: nop | 66 81 05 05 00 00 00 01 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; add word [rel @prev5], 0x0080      | 90 90 90 90 90 66 81 05 f2 ff ff ff 80 00    |
    | .prev1: nop; add word [rel @prev1], 0x00ff                          | 90 66 81 05 f6 ff ff ff ff 00                |
    | add word [rel @next1], 0x0100; nop; .next1: nop                     | 66 81 05 01 00 00 00 00 01 90 90             |
    | add word [rel @next5], 0x7fff; nop; nop; nop; nop; nop; .next5: nop | 66 81 05 05 00 00 00 ff 7f 90 90 90 90 90 90 |
    | ------------------------------------------------------------------- | -------------------------------------------- |
"""
...
ADD_ADDR16_REG16 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add word [rel @prev5], cx      | 90 90 90 90 90 66 01 0d f4 ff ff ff    |
    | .prev1: nop; add word [rel @prev1], cx                          | 90 66 01 0d f8 ff ff ff                |
    | add word [rel @next1], cx; nop; .next1: nop                     | 66 01 0d 01 00 00 00 90 90             |
    | add word [rel @next5], cx; nop; nop; nop; nop; nop; .next5: nop | 66 01 0d 05 00 00 00 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; add word [rel @prev5], sp      | 90 90 90 90 90 66 01 25 f4 ff ff ff    |
    | .prev1: nop; add word [rel @prev1], bp                          | 90 66 01 2d f8 ff ff ff                |
    | add word [rel @next1], si; nop; .next1: nop                     | 66 01 35 01 00 00 00 90 90             |
    | add word [rel @next5], di; nop; nop; nop; nop; nop; .next5: nop | 66 01 3d 05 00 00 00 90 90 90 90 90 90 |
    | --------------------------------------------------------------- | -------------------------------------- |
"""
...
ADD_ADDR8_IMM8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add byte [rel @prev5], 0x01      | 90 90 90 90 90 80 05 f4 ff ff ff 01    |
    | .prev1: nop; add byte [rel @prev1], 0x01                          | 90 80 05 f8 ff ff ff 01                |
    | add byte [rel @next1], 0x01; nop; .next1: nop                     | 80 05 01 00 00 00 01 90 90             |
    | add byte [rel @next5], 0x01; nop; nop; nop; nop; nop; .next5: nop | 80 05 05 00 00 00 01 90 90 90 90 90 90 |
    ...
    | .prev5: nop; nop; nop; nop; nop; add byte [rel @prev5], 0xff      | 90 90 90 90 90 80 05 f4 ff ff ff ff    |
    | .prev1: nop; add byte [rel @prev1], 0x00                          | 90 80 05 f8 ff ff ff 00                |
    | add byte [rel @next5], 0x7f; nop; nop; nop; nop; nop; .next5: nop | 80 05 05 00 00 00 7f 90 90 90 90 90 90 |
    | ----------------------------------------------------------------- | -------------------------------------- |
"""
...
ADD_ADDR8_REG8 = """
    ...
    | .prev5: nop; nop; nop; nop; nop; add byte [rel @prev5], cl       | 90 90 90 90 90 00 0d f5 ff ff ff       |
    | .prev1: nop; add byte [rel @prev1], cl                           | 90 00 0d f9 ff ff ff                   |
    | add byte [rel @next1], cl; nop; .next1: nop                      | 00 0d 01 00 00 00 90 90                |
    | add byte [rel @next5], cl; nop; nop; nop; nop; nop; .next5: nop  | 00 0d 05 00 00 00 90 90 90 90 90 90    |
    ...
    | .prev5: nop; nop; nop; nop; nop; add byte [rel @prev5], spl      | 90 90 90 90 90 40 00 25 f4 ff ff ff    |
    | .prev1: nop; add byte [rel @prev1], bpl                          | 90 40 00 2d f8 ff ff ff                |
    | add byte [rel @next1], sil; nop; .next1: nop                     | 40 00 35 01 00 00 00 90 90             |
    | add byte [rel @next5], dil; nop; nop; nop; nop; nop; .next5: nop | 40 00 3d 05 00 00 00 90 90 90 90 90 90 |
    | ---------------------------------------------------------------- | -------------------------------------- |
"""
